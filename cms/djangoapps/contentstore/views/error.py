...
__all__ = ['not_found', 'server_error', 'render_404', 'render_500', 'render_maintenance']
...
def render_maintenance(request):
    return HttpResponseServerError(render_to_string('maintenance.html', {}, request=request))