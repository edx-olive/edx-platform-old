...
(function(globals) {
  ...
  var newcatalog = {
    ...
    " learner does not exist in LMS and not added to the exception list": " \u00e9tudiant n'existe pas dans le LMS et n'a pas \u00e9t\u00e9 ajout\u00e9 \u00e0 la liste des d\u00e9rogations",
    " learner is already white listed and not added to the exception list": " \u00e9tudiant est d\u00e9j\u00e0 pr\u00e9sent dans la liste blanche et n'a pas \u00e9t\u00e9 ajout\u00e9 \u00e0 la liste des d\u00e9rogations",
    " learner is not enrolled in course and not added to the exception list": " \u00e9tudiant n'est pas inscrit au cours et n'a pas \u00e9t\u00e9 ajout\u00e9 \u00e0 la liste des d\u00e9rogations",
    " learner is successfully added to the exception list": " \u00e9tudiant ajout\u00e9 avec succ\u00e8s \u00e0 la liste des d\u00e9rogations",
    " learners are already white listed and not added to the exception list": " \u00e9tudiants sont d\u00e9j\u00e0 pr\u00e9sents dans la liste blanche et n'ont pas \u00e9t\u00e9 ajout\u00e9s \u00e0 la liste des d\u00e9rogations",
    " learners are not enrolled in course and not added to the exception list": " \u00e9tudiants ne sont pas inscrits au cours et n'ont pas \u00e9t\u00e9 ajout\u00e9s \u00e0 la liste des d\u00e9rogations",
    " learners are successfully added to exception list": " \u00e9tudiants ajout\u00e9s avec succ\u00e8s \u00e0 la liste des d\u00e9rogations",
    " learners do not exist in LMS and not added to the exception list": " \u00e9tudiants n'existent pas dans le LMS et n'ont pas \u00e9t\u00e9 ajout\u00e9s \u00e0 la liste des d\u00e9rogations",
    " record is not in correct format and not added to the exception list": " enregistrement n'est pas au bon format et n'a pas \u00e9t\u00e9 ajout\u00e9 \u00e0 la liste des d\u00e9rogations",
    " records are not in correct format and not added to the exception list": " enregistrements ne sont pas au bon format et n'ont pas pas \u00e9t\u00e9 ajout\u00e9s \u00e0 la liste des d\u00e9rogations",
    ...
    "%(field)s must have at least %(count)d characters.": "Les %(field)s doivent comporter au moins %(count)d caract\u00e8res.",
    "%(new_item_message)s": "%(new_item_message)s",
    "%(programName)s Home Page.": "Page d'accueil d'%(programName)s.",
    ...
    "<%= user %> already in exception list.": "<%= user %> est d\u00e9j\u00e0 dans la liste des d\u00e9rogations.",
    "<%= user %> has been successfully added to the exception list. Click Generate Exception Certificate below to send the certificate.": "<%= user %> a \u00e9t\u00e9 ajout\u00e9 avec succ\u00e8s \u00e0 la liste des d\u00e9rogations. Cliquez ci-dessous sur G\u00e9n\u00e9rer le certificat de d\u00e9rogation pour l'envoyer.",
    ...
    "Accomplishments Pagination": "Pagination des objectifs atteints",
    "Account": "Compte",
    "Account Information": "Informations sur le compte",
    "Account Not Activated": "Compte non activ\u00e9",
    "Account Settings": "Param\u00e8tres du compte",
    "Account Settings page.": "page des param\u00e8tres du compte.",
    ...
    "Add": "Ajouter",
    "Add Additional Signatory": "Ajouter une signature suppl\u00e9mentaire.",
    "Add Attachment": "Ajouter une Pi\u00e8ce jointe.",
    "Add Cohort": "Ajouter une cohorte",
    "Add Component:": "Ajouter un composant\u00a0:",
    "Add Country": "Entrez un pays",
    ...
    "Add a clear and descriptive title to encourage participation. (Required)": "Ajoutez un titre clair et explicite. (Requis)",
    "Add a comment": "Ajouter un commentaire",
    "Add a learning outcome here": "Ajoutez ici un r\u00e9sultat d'apprentissage",
    "Add a response:": "Ajouter une r\u00e9ponse\u00a0:",
    "Add another group": "Ajouter un autre groupe",
    "Add language": "Ajouter une langue",
    "Add learners to this cohort": "Ajouter des \u00e9tudiants \u00e0 cette cohorte",
    "Add notes about this learner": "Ajouter des notes \u00e0 propos de cet \u00e9tudiant",
    "Add to Dictionary": "Ajouter au dictionnaire",
    "Add to Exception List": "Ajouter \u00e0 la liste des d\u00e9rogations",
    ...
    "Add your post to a relevant topic to help others find it. (Required)": "Ajoutez votre message \u00e0 un sujet de discussion qui correspond pour aider les autres participants \u00e0 le trouver. (Requis)",
    "Add {role} Access": "Ajouter un acc\u00e8s {role}",
    "Adding": "Ajout",
    "Adding the selected course to your cart": "Ajout dans le panier en cours",
    "Additional Credit Opportunities": "Autres possibilit\u00e9s d'obtention de cr\u00e9dits",
    "Additional Information": "Informations suppl\u00e9mentaires",
    "Additional Professional Opportunities": "Autres possibilit\u00e9s professionnelles",
    "Additional Time (minutes)": "Temps additionnel (minutes)",
    "Additional posts could not be loaded. Refresh the page and try again.": "Aucun message suppl\u00e9mentaire n'a pu \u00eatre t\u00e9l\u00e9charg\u00e9. Veuillez actualiser la page et essayer \u00e0 nouveau.",
    ...
    "After the subsection\\'s due date has passed, learners can no longer access its content. The subsection remains included in grade calculations.": "Apr\u00e8s que la date limite de la sous-section soit pass\u00e9e, les \u00e9tudiants ne peuvent plus acc\u00e9der \u00e0 son contenu. La sous-section reste incluse dans les calculs de note.",
    ...
    "All learners in the {cohort_name} cohort": "Tous les \u00e9tudiants de la cohorte {cohort_name}",
    "All learners in the {track_name} track": "Tout \u00e9tudiant dans le parcours de {track_name}",
    "All learners who are enrolled in this course": "Tous les \u00e9tudiants inscrits \u00e0 ce cours",
    ...
    "All users on the Exception list": "Tous les utilisateurs sur la liste des d\u00e9rogations",
    "All users on the Exception list who do not yet have a certificate": "Tous les utilisateurs sur la liste des d\u00e9rogations qui n'ont pas encore de certificat",
    ...
    "Allow others to copy, distribute, display and perform your work - and derivative works based upon it - but for noncommercial purposes only.": "Autoriser d'autres personnes \u00e0 copier, distribuer, afficher et utiliser votre travail - et toute \u0153uvre qui en est d\u00e9riv\u00e9e - mais seulement \u00e0 des fins non\u00a0commerciales.",
    "Allow others to distribute derivative works only under a license identical to the license that governs your work. This option is incompatible with \"No Derivatives\".": "Autoriser d'autres personnes \u00e0 distribuer des travaux d\u00e9riv\u00e9s sous une licence identique \u00e0 celle s'appliquant \u00e0 votre \u0153uvre. Cette option est incompatible avec l'option \"Pas de travaux d\u00e9riv\u00e9s\".",
    ...
    "Always divide content-specific discussion topics": "Toujours s\u00e9parer les sujets de discussion",
    "Always show assessment results": "Toujours afficher les r\u00e9sultats d'\u00e9valuation",
    "Amount": "Montant",
    "An email has been sent to {userEmail} with a link for you to activate your account.": "Un e-mail a \u00e9t\u00e9 envoy\u00e9 \u00e0 {userEmail} avec un lien vous permettant d'activer votre compte.",
    "An error has occurred. Check your Internet connection and try again.": "Une erreur est survenue. V\u00e9rifiez votre connexion internet et r\u00e9essayez \u00e0 nouveau.",
    "An error has occurred. Make sure that you are connected to the Internet, and then try refreshing the page.": "Une erreur est survenue. Assurez-vous que vous \u00eates bien connect\u00e9 \u00e0 Internet et essayez d'actualiser la page.",
    "An error has occurred. Please try again later.": "Une erreur est survenue. Veuillez essayer \u00e0 nouveau.",
    "An error has occurred. Please try again.": "Une erreur est survenue. Veuillez r\u00e9essayer \u00e0 nouveau.",
    "An error has occurred. Please try reloading the page.": "Une erreur est survenue. Essayez d'actualiser la page.",
    "An error has occurred. Refresh the page, and then try again.": "Une erreur est survenue. Actualisez la page et r\u00e9essayez.",
    "An error has occurred. Try refreshing the page, or check your Internet connection.": "Une erreur est survenue. Essayez d'actualiser la page, ou v\u00e9rifiez votre connexion internet.",
    ...
    "An error occurred retrieving your email. Please try again later, and contact technical support if the problem persists.": "Une erreur est survenue lors de la r\u00e9cup\u00e9ration de votre e-mail. Veuillez r\u00e9essayer plus tard, et contactez le support technique si le probl\u00e8me persiste.",
    ...
    "An error occurred. Make sure that the student's username or email address is correct and try again.": "Une erreur est survenue. Assurez-vous que l'identifiant et l'e-mail de l'\u00e9tudiant sont corrects et essayez \u00e0 nouveau.",
    "An error occurred. Please reload the page.": "Une erreur est survenue. Veuillez actualiser la page.",
    ...
    "Any course progress or grades from your current session will be lost.": "L'avancement et les notes de votre session actuelle seront perdus.",
    ...
    "April": "Avril",
    "Are you having trouble finding a team to join?": "Avez-vous des difficult\u00e9s \u00e0 trouver une \u00e9quipe \u00e0 rejoindre\u00a0?",
    ...
    "Are you sure you want to unenroll from the purchased course {courseName} ({courseNumber})?": "Voulez-vous vraiment vous d\u00e9sinscrire du cours payant {courseName} ({courseNumber})\u00a0?",
    "Are you sure you want to unenroll from the verified {certNameLong}  track of {courseName}  ({courseNumber})?": "Voulez-vous vraiment vous d\u00e9sinscrire du parcours v\u00e9rifi\u00e9 {certNameLong} pour {courseName}  ({courseNumber})\u00a0?",
    "Are you sure you want to unenroll from the verified {certNameLong} track of {courseName} ({courseNumber})?": "Voulez-vous vraiment vous d\u00e9sinscrire du parcours v\u00e9rifi\u00e9 {certNameLong} pour {courseName} ({courseNumber})\u00a0?",
    "Are you sure you want to unenroll from {courseName} ({courseNumber})?": "Voulez-vous vraiment vous d\u00e9sinscrire du cours {courseName} ({courseNumber})\u00a0?",
    ...
    "As part of the verification process, you take a photo of both your face and a photo ID. Our authorization service confirms your identity by comparing the photo you take with the photo on your ID.": "Dans le cadre du processus de v\u00e9rification, vous prenez une photo de votre visage et de votre pi\u00e8ce d'identit\u00e9. Notre service d'autorisation confirme votre identit\u00e9 en comparant votre visage \u00e0 la photo de la pi\u00e8ce d'identit\u00e9.",
    ...
    "Assign Team Memberships": "Attribuer les adh\u00e9sions \u00e0 l'\u00e9quipe",
    "Assign learners to cohorts by uploading a CSV file": "R\u00e9partissez les \u00e9tudiants entre les cohortes en t\u00e9l\u00e9chargeant un fichier .csv",
    ...
    "Back to sign in": "Retourner \u00e0 la page de connexion",
    ...
    "Bookmarked": "Signet ajout\u00e9",
    "Bookmarked on": "Signet ajout\u00e9 le",
    "Border": "Bordure",
    "Border color": "Couleur de bordure",
    "Bottom": "Bas",
    "Browse": "Parcourir",
    "Browse recently launched courses and see what\\'s new in your favorite subjects": "Parcourez les cours les plus r\u00e9cents et d\u00e9couvrez les nouveaut\u00e9s li\u00e9es \u00e0 vos sujets favoris",
    "Browsing": "Navigation",
    ...
    "Cannot drop more <%= types %> assignments than are assigned.": "Impossible de d\u00e9poser plus de devoirs de type <%= types %> qu'il n'est possible d'en assigner.",
    "Cannot join instructor managed team": "Impossible d'int\u00e9grer l'\u00e9quipe g\u00e9r\u00e9e par un enseignant",
    "Caption": "L\u00e9gende",
    ...
    "Certificate has been successfully invalidated for <%= user %>.": "Invalidation r\u00e9ussie pour le certificat de <%= user %>.",
    "Certificate name is required.": "Le nom du certificat est requis.",
    "Certificate of <%= user %> has already been invalidated. Please check your spelling and retry.": "Le certificat de <%= user %> a \u00e9t\u00e9 invalid\u00e9. Veuillez v\u00e9rifier votre saisie et r\u00e9essayer.",
    ...
    "Chapter name and asset_path are both required": "Le titre de chapitre et l'asset_path sont tout deux requis",
    ...
    "Check this box to receive an email digest once a day notifying you about new, unread activity from posts you are following.": "Cochez cette case pour recevoir une fois par jour un e-mail r\u00e9capitulatif des nouveaut\u00e9s dans les fils de discussion que vous suivez.",
    "Check this box to receive emails notifying you about new, unread activity from posts you are following.": "Cochez cette case pour recevoir des e-mails de notification concernant les nouveaux messages ou les publications non\u00a0lues que vous suivez.",
    "Check your email": "V\u00e9rifiez votre e-mail",
    "Check your email account for instructions to reset your password.": "Les instructions de r\u00e9initialisation du mot de passe vous ont \u00e9t\u00e9 envoy\u00e9es par e-mail.",
    "Check your email for an activation message.": "V\u00e9rifiez dans vos e-mails que vous avez re\u00e7u le message d'activation.",
    "Checkout": "Payer",
    ...
    "Clear Release Date/Time": "Effacer les date et heure de diffusion",
    ...
    "Click on this button to mute or unmute this video or press UP or DOWN buttons to increase or decrease volume level.": "Cliquez sur ce bouton pour couper ou remettre le son de la vid\u00e9o, ou appuyez sur les touches HAUT ou BAS pour augmenter ou diminuer le volume.",
    ...
    "Collapse Instructions": "R\u00e9duire les instructions",
    "Collapse/Expand this %(xblock_type)s": "D\u00e9velopper/R\u00e9duire cette %(xblock_type)s",
    "Color": "Couleur",
    "Cols": "Colonnes",
    "Column": "Colonne",
    ...
    "Community TA": "Assistant",
    "Complete courses on your schedule to ensure you stand out in your field!": "Compl\u00e9tez les cours planifi\u00e9s pour \u00eatre s\u00fbr de vous d\u00e9marquer dans votre domaine\u00a0!",
    "Completed": "Termin\u00e9",
    "Component": "Composant",
    ...
    "Cost": "Co\u00fbt",
    "Could not find Certificate Exception in white list. Please refresh the page and try again": "Impossible de trouver le certificat de d\u00e9rogation dans la liste blanche. Veuillez actualiser la page et r\u00e9essayez.",
    "Could not find Certificate Invalidation in the list. Please refresh the page and try again": "Impossible de trouver l'invalidation du certificat dans la liste. Veuillez actualiser la page et r\u00e9essayer.",
    "Could not find a user with username or email address '<%- identifier %>'.": "Impossible de trouver un utilisateur avec le nom d'utilisateur ou adresse e-mail \"<%- identifier %>\".",
    ...
    "Could not submit order": "La commande n'a pas pu \u00eatre envoy\u00e9e",
    ...
    "Course Handouts": "Supports de cours",
    ...
    "Course Number Override": "Remplacement du num\u00e9ro du cours",
    "Course Number:": "Num\u00e9ro du cours\u00a0:",
    "Course Outline": "Plan du cours",
    "Course Run:": "Session\u00a0:",
    "Course Start": "D\u00e9but du cours",
    "Course Title": "Titre du cours",
    "Course Title Override": "Remplacement du titre du cours",
    ...
    "Create a new team if you can't find an existing team to join, or if you would like to learn with friends you know.": "Cr\u00e9ez une nouvelle \u00e9quipe si vous ne trouvez pas une \u00e9quipe existante \u00e0 rejoindre, ou si vous d\u00e9sirez apprendre avec des personnes que vous connaissez.",
    ...
    "Delete student '<%- student_id %>'s state on problem '<%- problem_id %>'?": "Supprimer le statut de l'\u00e9tudiant '<%= student_id %>' sur le probl\u00e8me \"<%= problem_id %>\"\u00a0?",
    ...
    "Deleting a team is permanent and cannot be undone.All members are removed from the team, and team discussions can no longer be accessed.": "La suppression d'une \u00e9quipe est une action permanente qui ne peut pas \u00eatre annul\u00e9e. Tous les membres seront retir\u00e9s de l'\u00e9quipe et les discussions d'\u00e9quipe ne seront plus accessibles.",
    ...
    "Discussion admins, moderators, and TAs can make their posts visible to all students or specify a single group.": "Les administrateurs de discussion, mod\u00e9rateurs, et assistants peuvent rendre leur message visible pour tous les \u00e9tudiants ou seulement un groupe sp\u00e9cifique.",
    ...
    "Div": "Div",
    "Divide the selected content-specific discussion topics": "S\u00e9parer certains sujets de discussion",
    "Divided": "S\u00e9par\u00e9",
    ...
    "Drag to reorder": "Faites glisser pour modifier l'ordre",
    ...
    "EdX doesn't have a timed transcript for this video in Studio, but we found a transcript on YouTube. You can import the YouTube transcript or upload your own .srt transcript file.": "EdX ne dispose pas de transcription synchronis\u00e9e pour cette vid\u00e9o dans Studio, mais il existe une transcription YouTube. Vous pouvez importer la transcription Youtube ou t\u00e9l\u00e9charger votre propre fichier de transcription srt.",
    "EdX doesn\\'t have a timed transcript for this video. Please upload an .srt file.": "EdX ne dispose pas de transcription synchronis\u00e9e pour cette vid\u00e9o. Veuillez t\u00e9l\u00e9charger un fichier de transcription .srt.",
    "EdX has a timed transcript for this video. If you want to edit this transcript, you can download, edit, and re-upload the existing transcript. If you want to replace this transcript, upload a new .srt transcript file.": "EdX dispose d'une transcription synchronis\u00e9e pour cette vid\u00e9o. Si vous souhaitez modifier cette transcription, vous pouvez t\u00e9l\u00e9charger, modifier, et t\u00e9l\u00e9charger \u00e0 nouveau la transcription existante. Si vous souhaitez remplacer cette transcription, t\u00e9l\u00e9chargez un nouveau fichier srt.",
    "EdX has a timed transcript for this video. If you want to replace this transcript, upload a new .srt transcript file. If you want to edit this transcript, you can download, edit, and re-upload the existing transcript.": "EdX dispose d'une transcription synchronis\u00e9e pour cette vid\u00e9o. Si vous souhaitez remplacer cette transcription, t\u00e9l\u00e9chargez un nouveau fichier de transcription srt. Si vous souhaitez modifier cette transcription, vous pouvez envoyer, modifier et t\u00e9l\u00e9charger \u00e0 nouveau la transcription existante.",
    "Edit": "Modifier",
    ...
    "Engage with posts": "Participer \u00e0 la conversation",
    "Enroll Now": "S'inscrire maintenant",
    "Enrolled": "Inscrit",
    "Enrolling you in the selected course": "Votre inscription est en cours de finalisation.",
    ...
    "Enter 3-5 highlights to include in the email message that learners receive for this section (250 character limit).": "Saisissez 3-5 points cl\u00e9s \u00e0 inclure \u00e0 l'email qui sera envoy\u00e9 aux \u00e9tudiants de cette section (minimum 250 caract\u00e8res).",
    "Enter Due Date and Time": "Entrez la date et heure d'\u00e9ch\u00e9ance",
    "Enter Start Date and Time": "Entrez la date et heure de d\u00e9but",
    "Enter a student's username or email address.": "Entrez un nom d'utilisateur et un e-mail.",
    "Enter a username or email.": "Entrez un nom d'utilisateur ou un e-mail.",
    ...
    "Enter some details for your support request.": "Saisissez les d\u00e9tails de votre demande de support.",
    "Enter team description.": "Entrez la description de l'\u00e9quipe.",
    "Enter team name.": "Entrez le nom de l'\u00e9quipe.",
    "Enter the account information for your organization.": "Saisissez les informations du compte de votre association.",
    "Enter the enrollment code.": "Entrez le code d'inscription",
    "Enter the name of the cohort": "Entrez le nom de la cohorte",
    ...
    "Enter the username or email address of each learner that you want to add as an exception.": "Saisissez le nom d'utilisateur ou l'adresse e-mail de chaque \u00e9tudiant que vous souhaitez ajouter comme exception.",
    "Enter username or email": "Nom d'utilisateur ou e-mail",
    ...
    "Entrance exam state is being deleted for student '{student_id}'.": "Effacement du statut de l'examen d'entr\u00e9e pour l'\u00e9tudiant \"{student_id}\".",
    "Error": "Erreur",
    "Error adding learners.": "Erreur lors de l'ajout des \u00e9tudiants.",
    ...
    "Error assigning team memberships": "Erreur d'attribution des adh\u00e9sions \u00e0 l'\u00e9quipe",
    "Error changing user's permissions.": "Erreur lors du changement des permissions de l'utilisateur.",
    "Error deleting entrance exam state for student '{student_id}'. Make sure student identifier is correct.": "Erreur de suppression du statut d'examen d'entr\u00e9e pour l'\u00e9tudiant \"{student_id}\". Assurez-vous que l'identifiant \u00e9tudiant est correct.",
    ...
    "Error generating ORA data report. Please try again.": "Erreur lors de la g\u00e9n\u00e9ration du rapport de donn\u00e9es ORA. Veuillez essayer \u00e0 nouveau.",
    "Error generating grades. Please try again.": "Erreur lors de la g\u00e9n\u00e9ration des notes. Veuillez essayer \u00e0 nouveau.",
    "Error generating list of students who may enroll. Please try again.": "Erreur lors de la g\u00e9n\u00e9ration de la liste des \u00e9tudiants pouvant s'inscrire. Veuillez essayer \u00e0 nouveau.",
    "Error generating problem grade report. Please try again.": "Erreur lors de la g\u00e9n\u00e9ration du rapport des notes. Veuillez essayer \u00e0 nouveau.",
    "Error generating proctored exam results. Please try again.": "Erreur lors de la g\u00e9n\u00e9ration des r\u00e9sultats d'examens supervis\u00e9s. Veuillez essayer \u00e0 nouveau.",
    "Error generating student profile information. Please try again.": "Erreur lors de la cr\u00e9ation des informations du profil \u00e9tudiant. Veuillez essayer \u00e0 nouveau.",
    "Error generating survey results. Please try again.": "Erreur lors de la g\u00e9n\u00e9ration des r\u00e9sultats d'enqu\u00eate. Veuillez essayer \u00e0 nouveau.",
    "Error getting enrollment status for '<%- student_id %>'. Make sure that the student identifier is spelled correctly.": "Erreur lors de l'obtention du statut d'inscription de l'\u00e9tudiant <%- student_id %>. V\u00e9rifiez qu'il n'y a pas d'erreur dans l'identifiant de l'\u00e9tudiant.",
    ...
    "Error getting student progress url for '<%- student_id %>'. Make sure that the student identifier is spelled correctly.": "Erreur lors de l'obtention de l'URL de progression de l'\u00e9tudiant <%- student_id %>. V\u00e9rifiez qu'il n'y a pas d'erreur dans l'identifiant de l'\u00e9tudiant.",
    ...
    "Error importing course": "Erreur lors de l'import du cours",
    ...
    "Error posting your message.": "Erreur de publication de votre message.",
    ...
    "Error starting a task to rescore problem '<%- problem_id %>' for student '<%- student_id %>'. Make sure that the the problem and student identifiers are complete and correct.": "Erreur dans le recalcul de la note de l'exercice \"<%- problem_id %>\" pour l'\u00e9tudiant <%- student_id %>. V\u00e9rifiez qu'il n'y a pas d'erreur dans les identifiants de l'exercice et de l'\u00e9tudiant.",
    ...
    "Error while generating certificates. Please try again.": "Erreur lors de la g\u00e9n\u00e9ration des certificats. Veuillez essayer \u00e0 nouveau.",
    "Error while regenerating certificates. Please try again.": "Erreur lors de la g\u00e9n\u00e9ration des certificats. Veuillez essayer \u00e0 nouveau.",
    "Error.": "Erreur.",
    "Error:": "Erreur\u00a0:",
    "Error: ": "Erreur\u00a0:",
    "Error: Choosing failed.": "Erreur\u00a0: La s\u00e9lection a \u00e9chou\u00e9.",
    "Error: Connection with server failed.": "Erreur\u00a0: La connexion au serveur a \u00e9chou\u00e9.",
    ...
    "Error: User '<%- username %>' has not yet activated their account. Users must create and activate their accounts before they can be assigned a role.": "Erreur\u00a0: L'utilisateur \"<%- username %>\" n'a pas encore activ\u00e9 son compte. Les utilisateurs doivent cr\u00e9er et activer leurs comptes avant de pouvoir se voir attribuer un r\u00f4le.",
    ...
    "Exam timer and end exam button": "Minuteur d'examen et bouton de fin d'examen",
    ...
    "Explain if other.": "Expliquer si diff\u00e9rent.",
    ...
    "File {filename} exceeds maximum size of {maxFileSizeInMBs} MB": "Le fichier {filename} d\u00e9passe la taille maximum autoris\u00e9e\u00a0: {maxFileSizeInMBs} Mo",
    "Files must be in JPEG or PNG format.": "Les fichiers doivent \u00eatre au format JPEG ou PNG.",
    "Files that you upload must be PDFs or image files in .gif, .jpg, .jpeg, or .png format.": "Les fichiers que vous chargez doivent \u00eatre soit des PDF, soit des fichiers image au format .gif, .jpg, .jpeg ou .png.",
    "Files that you upload must be smaller than 5MB in size.": "Les fichiers que vous chargez doivent \u00eatre d'une taille inf\u00e9rieure \u00e0 5\u00a0Mo.",
    "Fill browser": "Plein \u00e9cran",
    "Filter": "Filtrer",
    "Filter and sort topics": "Filtre et tri des sujets",
    ...
    "Finish": "Terminer",
    "First time here?": "Vous vous connectez pour la premi\u00e8re fois\u00a0?",
    "Follow": "Suivre",
    "Follow or unfollow posts": "Choisissez de suivre ou de ne plus suivre un message",
    "Following": "Suivi",
    ...
    "For inquiries regarding assignments, grades, or structure of a specific course, please post in the discussion forums for that course directly.": "Pour toute question sur les devoirs, les notes ou la structure d'un cours, publiez vos questions directement sur les forums de discussion de ce cours.",
    "Format": "Formater",
    "Formats": "Formats",
    ...
    "Generate": "G\u00e9n\u00e9rer",
    "Generate Exception Certificates": "G\u00e9n\u00e9rer les certificats de d\u00e9rogation",
    ...
    "Go to {link} to change your password.": "Acc\u00e9dez \u00e0 {link} pour changer votre mot de passe.",
    "Go to {platform} Home": "Page d'accueil {platform}",
    ...
    "Group A": "Groupe A",
    "Group B": "Groupe B",
    "Group Configuration ID": "ID de la configuration du groupe",
    ...
    "HTML preview of post": "Aper\u00e7u HTML de l'article",
    ...
    "Headings": "Titres",
    "Height": "Hauteur",
    "Help Translate into {beta_language}": "Aider \u00e0 traduire en {beta_language}",
    "Help other learners decide whether to join your team by specifying some characteristics for your team. Choose carefully, because fewer people might be interested in joining your team if it seems too restrictive.": "Aidez les autres \u00e9tudiants \u00e0 d\u00e9cider s'ils veulent rejoindre votre \u00e9quipe en sp\u00e9cifiant quelques caract\u00e9ristiques de votre \u00e9quipe. Choisissez soigneusement votre description, car moins de personnes seront int\u00e9ress\u00e9es \u00e0 rejoindre votre \u00e9quipe si votre \u00e9quipe semble trop restrictive.",
    "Hide": "Masquer",
    ...
    "Hide content after course end date": "Masquer le contenu apr\u00e8s la date de fin de cours",
    "Hide content after due date": "Masquer le contenu apr\u00e8s la date d'\u00e9ch\u00e9ance",
    "Hide entire subsection": "Masquer toute la sous-section",
    "Hide from learners": "Masquer pour les \u00e9tudiants",
    ...
    "Highlight {highlight_index}": "Points cl\u00e9s {highlight_index}",
    ...
    "If the photos you submit are rejected, try moving the computer or camera orientation to change the lighting angle.  The most common reason for rejection is inability to read the text on the ID card.": "Si les photos que vous envoyez sont rejet\u00e9es, essayez de d\u00e9placer l'ordinateur ou l'orientation de la cam\u00e9ra de fa\u00e7on \u00e0 modifier l'angle d'\u00e9clairage. La raison la plus fr\u00e9quente de rejet est l'illisibilit\u00e9 du texte sur les pi\u00e8ces d'identit\u00e9.",
    ...
    "If the unit was previously published and released to learners, any changes you made to the unit when it was hidden will now be visible to learners.": "Si cette unit\u00e9 avait \u00e9t\u00e9 pr\u00e9c\u00e9demment publi\u00e9e et diffus\u00e9e aupr\u00e8s des \u00e9tudiants, tout changement que vous aviez effectu\u00e9 \u00e0 cette unit\u00e9 lorsqu'elle \u00e9tait cach\u00e9e sont maintenant visibles aux \u00e9tudiants.",
    "If the unit was previously published and released to students, any changes you made to the unit when it was hidden will now be visible to students. Do you want to proceed?": "Si l'unit\u00e9 a d\u00e9j\u00e0 \u00e9t\u00e9 publi\u00e9e et diffus\u00e9e aupr\u00e8s des \u00e9tudiants, tous les changements apport\u00e9s \u00e0 l'unit\u00e9 pendant qu'elle \u00e9tait cach\u00e9e seront d\u00e9sormais visibles par les \u00e9tudiants. Voulez-vous continuer\u00a0?",
    "If you are unable to access your account contact us via email using {email}.": "Si vous n'arrivez pas \u00e0 vous connecter \u00e0 votre compte, contactez-nous par e-mail \u00e0 l'adresse {email}.",
    ...
    "If you leave, you can no longer post in this team's discussions.Your place will be available to another learner.": "Si vous partez, vous ne pourrez plus publier dans les discussions de l'\u00e9quipe. Votre place sera lib\u00e9r\u00e9e pour un autre \u00e9tudiant.",
    ...
    "If you make this %(xblockType)s visible to learners, learners will be able to see its content after the release date has passed and you have published the unit. Only units that are explicitly hidden from learners will remain hidden after you clear this option for the %(xblockType)s.": "Si vous rendez ce %(xblockType)s visible aux \u00e9tudiants, les \u00e9tudiants pourront voir son contenu apr\u00e8s que la date de diffusion soit pass\u00e9e et que vous ayez publi\u00e9 cette unit\u00e9. Seules les unit\u00e9s qui sont explicitement cach\u00e9es des \u00e9tudiants resteront cach\u00e9es apr\u00e8s vous d\u00e9sactivez cette option pour ce %(xblockType)s.",
    "If you proceed, you will be unable to use this account to take courses on the {platformName} app, {siteName}, or any other site hosted by {platformName}.": "Si vous continuez, vous ne pourrez plus utiliser ce compte pour suivre des cours sur l'application {platformName}, le site {siteName} ou tout autre site h\u00e9berg\u00e9 par {platformName}.",
    ...
    "If you require assistance with taking either photo for submission, contact %(platformName)s support for additional suggestions.": "Si vous avez besoin d'aide pour prendre les photos \u00e0 envoyer, contactez le support %(platformName)s pour obtenir des conseils suppl\u00e9mentaires.",
    ...
    "Insert Image (upload file or type URL)": "Ins\u00e9rer une image",
    ...
    "Instructor tools": "Outils de l'enseignant",
    "Internal Server Error.": "Erreur interne du serveur.",
    "Introduction to Cookie Baking": "Introduction \u00e0 la r\u00e9alisation de cookies",
    "Invalid email address: {email}": "Adresse e-mail non valide\u00a0: {email}",
    ...
    "Learners are added to this cohort automatically.": "Les \u00e9tudiants sont automatiquement ajout\u00e9s \u00e0 cette cohorte.",
    "Learners are added to this cohort only when you provide their email addresses or usernames on this page.": "Les \u00e9tudiants sont ajout\u00e9e \u00e0 cette cohorte lorsque vous ajoutez leurs adresses e-mail ou noms d'utilisateurs dans cette page.",
    "Learners do not see the subsection in the course outline. The subsection is not included in grade calculations.": "Les \u00e9tudiants ne peuvent pas voir la sous-section dans le plan de cours. La sous-section n'est pas incluse dans les calculs de note.",
    "Learners do not see whether their answers to assessments were correct or incorrect, nor the score received, until after the course end date has passed.": "Les \u00e9tudiants ne peuvent voir ni si leurs r\u00e9ponses aux \u00e9valuations \u00e9taient justes ou fausses ni la note re\u00e7ue, avant la date de fin du cours. ",
    ...
    "List of uploaded files and assets in this course": "Liste des fichiers et des ressources t\u00e9l\u00e9charg\u00e9s dans ce cours",
    "Live view of webcam": "Aper\u00e7u en temps r\u00e9el de votre Webcam",
    "Load Another File": "T\u00e9l\u00e9charger un autre fichier",
    ...
    "Lock this asset": "Verrouiller cette ressource",
    ...
    "Minimum Score:": "Note minimum\u00a0:",
    "Module state successfully deleted.": "Statut du module supprim\u00e9 avec succ\u00e8s.",
    "More": "Plus",
    ...
    "Need help logging in?": "Vous avez besoin d'aide pour vous connecter\u00a0?",
    ...
    "No content-specific discussion topics exist.": "Aucun sujet de discussion sp\u00e9cifique",
    ...
    "No prerequisite": "Pas de pr\u00e9requis",
    ...
    "No transcript uploaded.": "Aucune transcription charg\u00e9e.",
    ...
    "Not divided": "Aucune s\u00e9paration",
    "Not in Use": "Non utilis\u00e9",
    "Not selected": "Non s\u00e9lectionn\u00e9",
    "Not specific to a course": "Cette caract\u00e9ristique n'est pas propre \u00e0 un cours.",
    "Not yet": "Pas encore",
    "Note": "Note",
    "Note: Do not hide graded assignments after they have been released.": "Remarque\u00a0: Veuillez ne pas masquer les devoirs not\u00e9s apr\u00e8s leur diffusion.",
    "Note: Learners can be in only one cohort. Adding learners to this group overrides any previous group assignment.": "Remarque\u00a0: Les \u00e9tudiants peuvent \u00eatre dans une seule cohorte. L'ajout d'\u00e9tudiants \u00e0 ce groupe effacera toute affectation pr\u00e9c\u00e9dente \u00e0 d'autres groupes.",
    ...
    "Once in position, use the Take Photo button {icon} to capture your ID": "Une fois en position, cliquez sur le bouton Prendre une photo {icon} pour prendre la photo de votre pi\u00e8ce d'identit\u00e9.",
    "Once in position, use the Take Photo button {icon} to capture your photo": "Une fois en position, cliquez sur le bouton Prendre une photo {icon} pour prendre la photo.",
    "Once you complete one of the program requirements you have a program record. This record is marked complete once you meet all program requirements. A program record can be used to continue your learning journey and demonstrate your learning to others.": "Lorsque vous remplissez l'une des exigences du programme, vous disposez d'un dossier de programme. Ce dossier est indiqu\u00e9 comme \u00e9tant complet une fois que vous r\u00e9pondez \u00e0 toutes les exigences du programme. Un dossier de programme peut \u00eatre utilis\u00e9 pour poursuivre votre parcours d'apprentissage et d\u00e9montrer vos connaissances.",
    "Once your account is deleted, you cannot use it to take courses on the {platformName} app, {siteName}, or any other site hosted by {platformName}.": "Une fois le compte supprim\u00e9, vous ne pouvez plus l'utiliser pour suivre des cours sur l'application {platformName}, le site {siteName} ou tout autre site h\u00e9berg\u00e9 par {platformName}.",
    "One or more rescheduling tasks failed.": "Une ou plusieurs t\u00e2ches de r\u00e9\u00e9chelonnement ont \u00e9chou\u00e9.",
    "Only <%= fileTypes %> files can be uploaded. Please select a file ending in <%= fileExtensions %> to upload.": "Seuls les fichiers de type <%= fileTypes %> peuvent \u00eatre t\u00e9l\u00e9charg\u00e9s. S\u00e9lectionnez un fichier se terminant par <%= fileExtensions %>.",
    ...
    "Optionally, link your personal accounts to the social media icons on your edX profile.": "Vous pouvez lier vos comptes personnels aux ic\u00f4nes de r\u00e9seaux sociaux sur votre profil edX.",
    ...
    "Organization:": "Organisation\u00a0:",
    "Other": "Autre",
    "Overall Score": "Note g\u00e9n\u00e9rale",
    "PDF Chapters": "Chapitres au format PDF",
    ...
    "Password assistance": "Aide pour les mots de passe",
    ...
    "Please add a photo of the instructor (Note: only JPEG or PNG format supported)": "Veuillez ajouter la photo de l'enseignant (Note\u00a0: seuls les formats JPEG et PNG sont pris en charge).",
    "Please add at least one chapter": "Ajoutez au moins un chapitre",
    "Please add the institute where the instructor is associated": "Veuillez ajouter l'institution \u00e0 laquelle l'enseignant est associ\u00e9",
    ...
    "Please describe this image or agree that it has no contextual value by checking the checkbox.": "D\u00e9crivez l'image ou confirmez qu'elle n'est qu'une illustration en cochant la case.",
    "Please do not use any spaces in this field.": "Veuillez ne pas utiliser d'espace dans ce champ.",
    "Please do not use any spaces or special characters in this field.": "Veuillez ne pas utiliser d'espace ou de caract\u00e8res sp\u00e9ciaux dans ce champ.",
    "Please enter a problem location.": "Veuillez entrer l'emplacement de l'exercice.",
    "Please enter a score.": "Veuillez saisir un r\u00e9sultat.",
    "Please enter a student email address or username.": "Veuillez entrer un nom d'utilisateur ou l'adresse e-mail d'un \u00e9tudiant.",
    "Please enter a term in the {anchorStart} search field{anchorEnd}.": "Saisissez un terme dans le {anchorStart}champ de recherche{anchorEnd}.",
    "Please enter a username or email.": "Veuillez saisir un nom d'utilisateur ou un e-mail.",
    ...
    "Please enter your log-in or recovery email address below and we will send you an email with instructions.": "Indiquez votre adresse e-mail de connexion ou de r\u00e9cup\u00e9ration ci-dessous et nous vous enverrons un e-mail contenant des instructions.",
    "Please fix the following errors:": "Veuillez rem\u00e9dier aux erreurs suivantes\u00a0:",
    "Please follow the instructions here to upload a file elsewhere and link to it: {maxFileSizeRedirectUrl}": "Veuillez suivre les instructions pr\u00e9sent\u00e9es ici pour t\u00e9l\u00e9charger un fichier ailleurs et cr\u00e9er un lien vers lui\u00a0: {maxFileSizeRedirectUrl}",
    "Please note: Deletion of your account and personal data is permanent and cannot be undone. {platformName} will not be able to recover your account or the data that is deleted.": "Remarque\u00a0: La suppression de votre compte et de vos donn\u00e9es personnelles est irr\u00e9versible. {platformName} ne pourra pas r\u00e9cup\u00e9rer votre compte ni les donn\u00e9es supprim\u00e9es.",
    "Please note: deletion of your account and personal data is permanent and cannot be undone. Ab Initio will not be able to recover your account or the data that is deleted. You will no longer be able to use the same email for Ab Initio Online Training.": "Remarque\u00a0: La suppression de votre compte et de vos donn\u00e9es personnelles est irr\u00e9versible. Ab\u00a0Initio ne pourra pas r\u00e9cup\u00e9rer votre compte ni les donn\u00e9es supprim\u00e9es. Vous ne pourrez plus utiliser la m\u00eame adresse e-mail pour les formations en ligne Ab\u00a0Initio.",
    ...
    "Please provide a description of the link destination.": "Veuillez fournir une description pour le lien.",
    ...
    "Please select a PDF file to upload.": "Veuillez s\u00e9lectionner un fichier PDF \u00e0 t\u00e9l\u00e9charger.",
    "Please select a file in .srt format.": "S\u00e9lectionnez un fichier au format .srt.",
    ...
    "Please verify that your webcam is connected and that you have allowed your browser to access it.": "V\u00e9rifiez que votre webcam est bien connect\u00e9e et que votre navigateur est autoris\u00e9 \u00e0 y acc\u00e9der.",
    ...
    "Practice Proctored": "Examen blanc surveill\u00e9",
    "Practice proctored Exam": "Examen blanc surveill\u00e9",
    "Pre": "Pr\u00e9",
    "Preferred Language": "Langue",
    "Preformatted": "Pr\u00e9format\u00e9",
    "Prerequisite:": "Pr\u00e9requis\u00a0:",
    "Prerequisite: %(prereq_display_name)s": "Conditions pr\u00e9alables\u00a0: %(prereq_display_name)s",
    ...
    "Press update settings to update the information for your organization.": "Appuyez sur mettre \u00e0 jour les param\u00e8tres pour mettre \u00e0 jour l'information de votre association.",
    ...
    "Previous Uploads table has been updated.": "La table pr\u00e9c\u00e9demment t\u00e9l\u00e9charg\u00e9e a \u00e9t\u00e9 mise \u00e0 jour",
    ...
    "Proctoring": "Surveillance d'examen",
    ...
    "Proctoring Settings": "Param\u00e8tres de surveillance d'examen",
    ...
    "Professional Education Verified Certificate": "Certificat v\u00e9rifi\u00e9 professionnel",
    "Profile": "Profil",
    ...
    "Publishing Status": "Statut de la publication",
    "Question": "Question",
    "Questions raise issues that need answers. Discussions share ideas and start conversations. (Required)": "Les questions soul\u00e8vent des probl\u00e9matiques qui n\u00e9cessitent une r\u00e9ponse. Les discussions permettent de partager des id\u00e9es et d'entamer des conversations. (Requis)",
    ...
    "Rejected": "Rejet\u00e9",
    "Related to: %(courseware_title_linked)s": "En rapport avec\u00a0: %(courseware_title_linked)s",
    ...
    "Report abuse, topics, and responses": "Signalez un abus, un sujet de discussion ou une r\u00e9ponse",
    "Reported": "Signal\u00e9",
    "Requester": "Demandeur",
    "Required": "Requis",
    "Required field.": "Champ requis.",
    ...
    "Saving your email preference": "Enregistrement de vos pr\u00e9f\u00e9rences e-mail",
    ...
    "Search the {platform} Help Center": "Lancer une recherche dans l'aide en ligne d'{platform}",
    ...
    "Sections": "Sections",
    "Security": "S\u00e9curit\u00e9",
    "See all teams you belong to and all public teams in your course, organized by topic.": "Affichez toutes les \u00e9quipes dont vous faites partie et toutes les \u00e9quipes publiques de votre cours, organis\u00e9es par sujet.",
    "See all teams you belong to and all public teams in your course, organized by topic. Join an open public team to collaborate with other learners who are interested in the same topic as you are.": "Affichez toutes les \u00e9quipes dont vous faites partie et toutes les \u00e9quipes publiques de votre cours, organis\u00e9es par sujets, et int\u00e9grez une \u00e9quipe publique ouverte pour collaborer avec d'autres \u00e9tudiants int\u00e9ress\u00e9s par les m\u00eames sujets que vous.",
    "See all teams you belong to.": "Affichez toutes les \u00e9quipes dont vous faites partie.",
    "Select": "S\u00e9lectionner",
    ...
    "Select a cohort": "S\u00e9lectionner une cohorte",
    "Select a cohort to manage": "S\u00e9lectionnez une cohorte",
    "Select a course or select \"Not specific to a course\" for your support request.": "S\u00e9lectionnez un cours ou s\u00e9lectionnez \"Cette caract\u00e9ristique n'est pas propre \u00e0 un cours\" pour votre demande de support.",
    "Select a group type": "S\u00e9lectionner un type de groupe",
    "Select a prerequisite subsection and enter a minimum score percentage and minimum completion percentage to limit access to this subsection. Allowed values are 0-100": "S\u00e9lectionnez une sous-section pr\u00e9requise et saisissez une note minimum en pourcentage et un pourcentage de r\u00e9ussite minimum afin de limiter l'acc\u00e8s \u00e0 cette sous-section. Les valeurs doivent \u00eatre comprises entre 0 et 100.",
    "Select a section or problem": "S\u00e9lectionner une section ou un probl\u00e8me",
    "Select a session:": "S\u00e9lectionnez une session\u00a0:",
    "Select a time allotment for the exam. If it is over 24 hours, type in the amount of time. You can grant individual learners extra time to complete the exam through the Instructor Dashboard.": "Choisissez une p\u00e9riode de temps pour l'examen. Si c'est plus de 24 heures, indiquer la quantit\u00e9 de temps. Vous pouvez accorder du temps suppl\u00e9mentaire \u00e0 des \u00e9tudiants individuels via le tableau de bord de l'enseignant afin de leur permettre de terminer l'examen.",
    "Select a topic for your support request.": "S\u00e9lectionnez un sujet pour votre demande de support.",
    "Select all": "Tout s\u00e9lectionner",
    "Select fidelity": "S\u00e9lectionnez la fid\u00e9lit\u00e9",
    "Select language": "S\u00e9lectionnez la langue",
    "Select one or more groups:": "S\u00e9lectionnez au moins un groupe\u00a0:",
    ...
    "Select the time zone for displaying course dates. If you do not specify a time zone, course dates, including assignment deadlines, will be displayed in your browser's local time zone.": "S\u00e9lectionnez votre fuseau horaire. Si aucun fuseau horaire n'est sp\u00e9cifi\u00e9, les dates de cours, y compris les \u00e9ch\u00e9ances des devoirs, seront d\u00e9finies en fonction du fuseau horaire local de votre navigateur.",
    "Select turnaround": "S\u00e9lectionner le d\u00e9lai d'ex\u00e9cution",
    ...
    "Sent To:": "Envoy\u00e9 \u00e0:",
    "September": "Septembre",
    "Sequence error! Cannot navigate to %(tab_name)s in the current SequenceModule. Please contact the course staff.": "Erreur de s\u00e9quence\u00a0! Impossible d'afficher l'onglet %(tab_name)s dans le module SequenceModule en cours. Veuillez contacter les responsables du cours.",
    "Server Error, Please refresh the page and try again.": "Erreur serveur. Veuillez actualiser la page et r\u00e9essayer.",
    ...
    "Show assessment results when subsection is past due": "Afficher les r\u00e9sultats d'\u00e9valuation lorsque la date de rendu de la sous-section est d\u00e9pass\u00e9e",
    ...
    "Showing all responses": "Affichage de toutes les r\u00e9ponses",
    ...
    "Showing {currentItemRange} out of {totalItemsCount}, filtered by {assetType}, sorted by {sortName} ascending": "{currentItemRange} sur {totalItemsCount}, filtr\u00e9s par {assetType}, tri\u00e9s par {sortName} par ordre croissant",
    "Showing {currentItemRange} out of {totalItemsCount}, filtered by {assetType}, sorted by {sortName} descending": "{currentItemRange} sur {totalItemsCount}, filtr\u00e9s par {assetType}, tri\u00e9s par {sortName} par ordre d\u00e9croissant",
    "Showing {currentItemRange} out of {totalItemsCount}, sorted by {sortName} ascending": "{currentItemRange} sur {totalItemsCount}, tri\u00e9s par {sortName} par ordre croissant",
    "Showing {currentItemRange} out of {totalItemsCount}, sorted by {sortName} descending": "{currentItemRange} sur {totalItemsCount}, tri\u00e9s par {sortName} par ordre d\u00e9croissant",
    "Showing {firstIndex} out of {numItems} total": "{firstIndex} surun total de {numItems}",
    "Showing {firstIndex}-{lastIndex} out of {numItems} total": "{firstIndex}-{lastIndex} sur un total de {numItems}",
    "Sign In": "Se connecter",
    "Sign in": "Se connecter",
    "Sign in here using your email address and password, or use one of the providers listed below.": "Connectez-vous avec votre e-mail et mot de passe, ou utiliser l'un des fournisseurs ci-dessous.",
    "Sign in here using your email address and password.": "Connectez-vous ici avec votre adresse e-mail et mot de passe.",
    "Sign in to continue learning": "Connectez-vous pour poursuivre votre formation",
    "Sign in to continue learning as {email}": "Connectez-vous pour poursuivre votre formation en tant que {email}",
    "Sign in to {platform} so we can help you better.": "Connectez-vous sur {platform} pour nous permettre de mieux vous aider.",
    ...
    "Signatory field(s) has invalid data.": "Donn\u00e9es non\u00a0valides pour les champs de signataire.",
    ...
    "Some images in this post have been omitted": "Certaines images dans ce message ont \u00e9t\u00e9 omises.",
    ...
    "Specify an alternative to the official course title to display on certificates. Leave blank to use the official course title.": "Sp\u00e9cifier une alternative au titre du cours officiel pour l'afficher sur les certificats. Laisser un vide pour utiliser le titre du cours officiel.",
    ...
    "Specify any rules or rule exceptions that the proctoring review team should enforce when reviewing the videos. For example, you could specify that calculators are allowed. These specified rules are visible to learners before the learners start the exam.": "Veuillez indiquer toute r\u00e8gle ou exception \u00e0 la r\u00e8gle que l'\u00e9quipe de r\u00e9vision d'examens surveill\u00e9s doit imposer lors de la r\u00e9vision des vid\u00e9os. Par exemple, vous pourriez indiquer que les calculatrices sont permises. Ces r\u00e8gles pr\u00e9cis\u00e9es sont visibles aux \u00e9tudiants avant que les \u00e9tudiants ne commencent l'examen.",
    "Specify whether content-specific discussion topics are divided.": "Pr\u00e9cisez si les diff\u00e9rents sujets de discussion sont s\u00e9par\u00e9s.",
    "Specify whether discussion topics are divided": "Pr\u00e9cisez si les sujets de discussion sont s\u00e9par\u00e9s.",
    "Speed": "Vitesse",
    ...
    "Staff and Learners": "\u00c9quipe p\u00e9dagogique et \u00e9tudiants",
    ...
    "Start regenerating certificates for students in this course?": "D\u00e9marrer la r\u00e9g\u00e9n\u00e9ration des certificats pour les \u00e9tudiants du cours\u00a0?",
    ...
    "Started": "D\u00e9but\u00e9",
    "Started entrance exam rescore task for student '{student_id}'. Click the 'Show Task Status' button to see the status of the task.": "Le recalcul du score de l'examen d'entr\u00e9e de l'\u00e9tudiant {student_id}'a commenc\u00e9. Cliquez sur le bouton \"Afficher le statut de la t\u00e2che\" pour voir son statut.",
    "Started rescore problem task for problem '<%- problem_id %>' and student '<%- student_id %>'. Click the 'Show Task Status' button to see the status of the task.": "Le recalcul de la note de l'exercice <%- problem_id %> de l'\u00e9tudiant <%- student_id %> a commenc\u00e9. Cliquez sur le bouton \"Afficher le statut de la t\u00e2che\" pour voir le statut.",
    "Started task to override the score for problem '<%- problem_id %>' and student '<%- student_id %>'. Click the 'Show Task Status' button to see the status of the task.": "La t\u00e2che de remplacement de la note pour l'exercice <%- problem_id %> de l'\u00e9tudiant <%- student_id %>' a commenc\u00e9. Cliquez sur le bouton \"Afficher le statut de la t\u00e2che\" pour voir son statut.",
    ...
    "Student email or username": "Nom d'utilisateur ou e-mail",
    "Student username/email field is required and can not be empty. Kindly fill in username/email and then press \"Add to Exception List\" button.": "Le champ Nom d'utilisateur/e-mail de l'\u00e9tudiant est obligatoire et ne peut \u00eatre vide. Veuillez saisir le nom d'utilisateur/e-mail, puis cliquez sur le bouton \"Ajouter \u00e0 la liste des d\u00e9rogations\".",
    "Student username/email field is required and can not be empty. Kindly fill in username/email and then press \"Invalidate Certificate\" button.": "Le champ nom d'utilisateur / e-mail de l'\u00e9tudiant est requis et ne peut \u00eatre vide. Veuillez le saisir, puis appuyez sur le bouton \"Invalider le certificat\".",
    "Studio's having trouble saving your work": "Studio rencontre des probl\u00e8mes pour sauvegarder votre travail",
    "Studio:": "Studio\u00a0:",
    "Style": "Style",
    "Subject": "Sujet\u00a0",
    "Subject:": "Sujet\u00a0:",
    "Submission aborted! Sorry, your browser does not support file uploads. If you can, please use Chrome or Safari which have been verified to support file uploads.": "T\u00e9l\u00e9chargement annul\u00e9. Votre navigateur ne prend pas en charge le t\u00e9l\u00e9chargement de fichiers. Si possible, utilisez Chrome ou Safari.",
    "Submit": "Envoyer",
    "Submit Application": "Soumettre votre candidature",
    "Submit enrollment change": "Envoyer la modification d'inscription",
    "Submitted": "Envoy\u00e9",
    "Subscript": "Indice",
    ...
    "Subsection is hidden after due date": "La sous-section est masqu\u00e9e apr\u00e8s la date d'\u00e9ch\u00e9ance",
    ...
    "Successfully enrolled and sent email to the following users:": "Inscription et envoi d'e-mail r\u00e9ussis pour les utilisateurs suivants\u00a0:",
    ...
    "Successfully rescored problem for user {user}": "R\u00e9\u00e9valuation de la note de l'exercice r\u00e9ussie pour {user}.",
    "Successfully rescored problem to improve score for user {user}": "R\u00e9\u00e9valuation du probl\u00e8me effectu\u00e9e pour {user} (\u00e0 son avantage).",
    ...
    "Successfully started task to rescore problem '<%- problem_id %>' for all students. Click the 'Show Task Status' button to see the status of the task.": "D\u00e9marrage du recalcul de la note de l'exercice <%- problem_id %> pour tous les \u00e9tudiants. Cliquez sur le bouton \"Afficher le statut de la t\u00e2che\" pour voir son statut.",
    "Successfully started task to reset attempts for problem '<%- problem_id %>'. Click the 'Show Task Status' button to see the status of the task.": "La t\u00e2che de r\u00e9initialisation des essais autoris\u00e9s pour l'exercice \"<%- problem_id %>\" a commenc\u00e9. Cliquez sur le bouton \"Afficher le statut de la t\u00e2che\" pour voir son statut.",
    ...
    "Switch Language Back": "Revenir \u00e0 la langue initiale",
    "TOTAL": "TOTAL",
    "Table": "Tableau",
    ...
    "Team \"{team}\" successfully deleted.": "\u00c9quipe \"{team}\" supprim\u00e9e avec succ\u00e8s.",
    ...
    "Textbook information": "informations sur le manuel",
    "Textbook name is required": "Le nom du manuel est requis",
    "Thank you %(full_name)s! We have received your payment for %(course_name)s.": "Merci %(full_name)s. Nous avons re\u00e7u votre paiement pour le cours %(course_name)s.",
    "Thank you for setting your course goal to {goal}!": "Vous avez d\u00e9fini {goal} comme objectif de cours.",
    "Thank you for submitting a request! We appreciate your patience while we work to review your request.": "Nous vous remercions pour votre demande\u00a0! Nous y r\u00e9pondrons dans les plus brefs d\u00e9lais. Merci de votre patience.",
    "Thank you for submitting your financial assistance application for {course_name}! You can expect a response in 2-4 business days.": "Nous avons bien re\u00e7u votre demande d'aide financi\u00e8re pour le cours {course_name}. Vous aurez une r\u00e9ponse sous 2 \u00e0 4\u00a0jours ouvrables.",
    "Thank you for submitting your photos. We will review them shortly. You can now sign up for any %(platformName)s course that offers verified certificates. Verification is good for one year. After one year, you must submit photos for verification again.": "Merci d'avoir envoy\u00e9 vos photos. Nous allons les valider rapidement. Vous pouvez maintenant vous inscrire \u00e0 tous les cours %(platformName)s offrant un certificat v\u00e9rifi\u00e9. La v\u00e9rification est valable pendant un an. Apr\u00e8s cette dur\u00e9e, vous devrez renvoyer vos photos pour v\u00e9rification.",
    "Thank you! We have received your payment for {courseName}.": "Merci. Nous avons bien re\u00e7u votre paiement pour {courseName}.",
    "Thanks for returning to verify your ID in: {courseName}": "Merci pour votre v\u00e9rification d'ID pour\u00a0: {courseName}",
    "The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?": "L'URL que vous avez entr\u00e9e semble \u00eatre une adresse e-mail. Voulez-vous ajouter le pr\u00e9fixe requis mailto:\u00a0?",
    ...
    "The certificate for this learner has been re-validated and the system is re-running the grade for this learner.": "Le certificat de cet \u00e9tudiant a \u00e9t\u00e9 re-valid\u00e9 et le syst\u00e8me est en train de r\u00e9-\u00e9valuer les notes de cet \u00e9tudiant.",
    ...
    "The country or region where you live.": "Pays ou r\u00e9gion o\u00f9 vous vivez.",
    ...
    "The display language used throughout this site for menus, buttons, and other parts of the user interface. This site is currently available in a limited number of languages. Changing the value of this field will cause the page to refresh. To set your preferred language for course videos, exercise instructions, and transcripts, choose a Preferred Language below.": "Langue d'affichage utilis\u00e9e sur ce site pour les menus, les boutons et les diff\u00e9rentes parties de l'interface. Ce site est disponible pour certaines langues. Le changement de valeur de ce champ rafra\u00eechira la page. Pour d\u00e9finir la langue \u00e0 utiliser pour les vid\u00e9os, les instructions des exercices et les transcriptions, s\u00e9lectionnez une langue ci-dessous.",
    ...
    "The following email addresses and/or usernames are invalid:": "Les adresses e-mail et/ou noms d'utilisateurs suivants ne sont pas valides\u00a0:",
    ...
    "The following information is already a part of your {platform} profile. We've included it here for your application.": "Les informations suivantes figurent d\u00e9j\u00e0 dans votre profil de {platform}. Elles sont ajout\u00e9es ici pour faciliter votre candidature.",
    ...
    "The grading process is still running. Refresh the page to see updates.": "Le processus d'\u00e9valuation est toujours en cours. Actualisez la page pour voir les changements.",
    "The language that team members primarily use to communicate with each other.": "Langue principalement utilis\u00e9e par les membres de l'\u00e9quipe pour communiquer entre eux.",
    "The language used throughout this site. This site is currently available in a limited number of languages. Changing the value of this field will cause the page to refresh.": "Langue utilis\u00e9e sur ce site. Notre site est actuellement disponible dans un nombre limit\u00e9 de langues. La modification de la valeur de ce champ provoquera une actualisation de la page.",
    ...
    "The more you tell us, the more quickly and helpfully we can respond!": "Plus vous donnez de d\u00e9tails, plus vite nous serons en mesure de vous r\u00e9pondre.",
    "The name of this signatory as it should appear on certificates.": "Nom du signataire tel qu'il doit appara\u00eetre sur les certificats.",
    "The name that identifies you on {platform_name}. You cannot change your username.": "Nom qui vous identifie sur {platform_name}. Vous ne pouvez pas modifier votre nom d'utilisateur.",
    "The name that is used for ID verification and that appears on your certificates.": "Nom utilis\u00e9 pour la v\u00e9rification de votre identit\u00e9 qui appara\u00eetra sur vos certificats.",
    "The number of assignments of this type that will be dropped. The lowest scoring assignments are dropped first.": "Le nombre de devoirs de ce type qui sont ignor\u00e9s. Les scores des devoirs les plus bas seront ignor\u00e9s en premier.",
    ...
    "The organization that this signatory belongs to, as it should appear on certificates.": "L'organisation \u00e0 laquelle cet \u00e9tudiant appartient, telle qu'elle devrait appara\u00eetre sur les certificats.",
    ...
    "The selected image must be smaller than {maxFileSizeInMB}.": "L'image s\u00e9lectionn\u00e9e doit \u00eatre plus petite que {maxFileSizeInMB}.",
    ...
    "The team \"{team}\" could not be found.": "\u00c9quipe \"{team}\" non trouv\u00e9e.",
    ...
    "The timer on the right shows the time remaining in the exam.": "Le minuteur \u00e0 droite indique le temps restant pour l'examen.",
    "The topic \"{topic}\" could not be found.": "Sujet \"{topicalise}\" non trouv\u00e9.",
    ...
    "The {cohortGroupName} cohort has been created. You can manually add students to this cohort below.": "La cohorte {cohortGroupName} a \u00e9t\u00e9 cr\u00e9\u00e9e. Vous pouvez y ajouter manuellement des \u00e9tudiants ci-dessous.",
    "There are invalid keywords in your email. Check the following keywords and try again.": "Votre e-mail contient des mots cl\u00e9s non\u00a0valides. V\u00e9rifiez les mots cl\u00e9s suivants et recommencez.",
    ...
    "There has been an error processing your survey.": "Une erreur est survenue lors du traitement de votre questionnaire.",
    "There has been an error while exporting.": "Une erreur est survenue lors de l'export.",
    ...
    "There is no email history for this course.": "Il n'y a pas d'historique d'e-mail pour ce cours",
    ...
    "There was a problem creating the report. Select \"Create Executive Summary\" to try again.": "Une probl\u00e8me est survenu lors de la cr\u00e9ation du rapport. S\u00e9lectionnez \"Cr\u00e9er un r\u00e9sum\u00e9 op\u00e9rationnel\" pour d'essayer \u00e0 nouveau.",
    "There was an error changing the user's role": "Une erreur est survenue lors du changement de r\u00f4le pour cet utilisateur",
    "There was an error during the upload process.": "Une erreur est survenue pendant le processus de chargement.",
    "There was an error obtaining email content history for this course.": "Une erreur est survenue lors de l'obtention de l'historique du contenu des e-mails pour ce cours.",
    "There was an error obtaining email task history for this course.": "Une erreur est survenue lors de l'obtention de l'historique des t\u00e2ches d'e-mail pour ce cours.",
    "There was an error retrieving preview results for this catalog. Please check that your query is correct and try again.": "Une erreur est survenue lors de la r\u00e9cup\u00e9ration de l'aper\u00e7u des r\u00e9sultats pour ce catalogue. Veuillez v\u00e9rifier que votre requ\u00eate est correcte et essayer \u00e0 nouveau.",
    "There was an error updating your goal.": "Une erreur est survenue lors de la mise \u00e0 jour de votre objectif.",
    "There was an error when trying to add learners:": [
      "Une erreur s'est produite lors de l'ajout d'\u00e9tudiants\u00a0:",
      "{numErrors} \u00e9tudiants n'ont pas pu \u00eatre ajout\u00e9s \u00e0 cette cohorte\u00a0:"
    ],
    "There was an error while importing the new course to our database.": "Une erreur est survenue pendant l'import du nouveau cours dans notre base de donn\u00e9es.",
    "There was an error while importing the new library to our database.": "Une erreur est survenue pendant l'import de la nouvelle biblioth\u00e8que dans notre base de donn\u00e9es.",
    "There was an error while unpacking the file.": "Une erreur est survenue pendant la d\u00e9compression du fichier.",
    "There was an error while verifying the file you submitted.": "Une erreur est survenue lors de la v\u00e9rification du fichier que vous avez envoy\u00e9.",
    "There was an error with the upload": "Une erreur est survenue pendant le chargement",
    ...
    "There's already another assignment type with this name.": "Il y a d\u00e9j\u00e0 un type de devoir avec ce nom.",
    "These settings include basic information about your account.": "Cette page regroupe les informations de base sur votre compte.",
    ...
    "These users were not removed as beta testers:": "Ces utilisateurs n'ont pas pu \u00eatre supprim\u00e9s de la liste des b\u00eata-testeurs\u00a0:",
    "These users were successfully added as beta testers:": "Ces utilisateurs ont \u00e9t\u00e9 ajout\u00e9s comme b\u00eata-testeurs\u00a0:",
    "These users were successfully removed as beta testers:": "Ces utilisateurs ont \u00e9t\u00e9 supprim\u00e9s de la liste des b\u00eata-testeurs\u00a0:",
    ...
    "This action updates the {provider} information for your entire organization.": "Cette action met \u00e0 jour l'information de {provider} pour toute association.",
    ...
    "This certificate has already been activated and is live. Are you sure you want to continue editing?": "Ce certificat a d\u00e9j\u00e0 \u00e9t\u00e9 activ\u00e9 et peut \u00eatre consult\u00e9. \u00cates-vous s\u00fbr de vouloir continuer la modification\u00a0?",
    "This comment could not be deleted. Refresh the page and try again.": "Ce commentaire n'a pas pu \u00eatre effac\u00e9. Actualisez la page et r\u00e9essayez.",
    ...
    "This feature is currently in testing. Course teams can enter highlights, but learners will not receive email messages.": "Cette fonction est actuellement en train d'\u00eatre contr\u00f4l\u00e9e. L'\u00e9quipe p\u00e9dagogique peut saisir les points cl\u00e9s, mais les \u00e9tudiants ne recevront pas d'e-mails.",
    ...
    "This image file type is not supported. Supported file types are {supportedFileFormats}.": "Ce type de fichier image n'est pas pris en charge. Les types de fichers pris en charge sont les suivants\u00a0: {supportedFileFormats}.",
    "This image is for decorative purposes only and does not require a description.": "Cette image est une illustration et ne n\u00e9cessite pas de description.",
    "This includes access to {siteName} from your employer\u2019s or university\u2019s system{additionalSiteSpecificDeletionText}.": "Cela comprend l'acc\u00e8s au site {siteName} fourni par le syst\u00e8me de votre employeur ou de votre universit\u00e9{additionalSiteSpecificDeletionText}.",
    ...
    "This learner is currently sharing a limited profile.": "Cet \u00e9tudiant partage actuellement un profil restreint.",
    "This learner will be removed from the team,allowing another learner to take the available spot.": "Cet \u00e9tudiant sera supprim\u00e9 de l'\u00e9quipe afin qu'un nouvel \u00e9tudiant puisse prendre la place vacante.",
    ...
    "This may be happening because of an error with our server or your internet connection. Try refreshing the page or making sure you are online.": "Cet incident vous affecte \u00e0 cause d'une erreur sur notre serveur ou d'un probl\u00e8me de votre connexion internet. Essayez d'actualiser la page ou v\u00e9rifiez que votre connexion est bien active.",
    "This page contains information about orders that you have placed with {platform_name}.": "Cette page contient des informations sur les commandes que vous avez pass\u00e9es avec {platform_name}.",
    "This post could not be closed. Refresh the page and try again.": "Ce message n'a pas pu \u00eatre ferm\u00e9. Veuillez actualiser la page et essayer \u00e0 nouveau.",
    "This post could not be flagged for abuse. Refresh the page and try again.": "Ce message n'a pas pu \u00eatre d\u00e9nonc\u00e9 pour abus. Veuillez actualiser la page et essayer \u00e0 nouveau.",
    "This post could not be pinned. Refresh the page and try again.": "Ce message n'a pas pu \u00eatre \u00e9pingl\u00e9. Veuillez actualiser la page et essayer \u00e0 nouveau.",
    "This post could not be reopened. Refresh the page and try again.": "Ce message n'a pas pu \u00eatre rouvert. Veuillez actualiser la page et essayer \u00e0 nouveau.",
    ...
    "This post could not be unpinned. Refresh the page and try again.": "n'a pas pu \u00eatre d\u00e9s\u00e9pingl\u00e9. Veuillez actualiser la page et essayer \u00e0 nouveau.",
    ...
    "This post will be visible only to %(group_name)s.": "Ce message sera visible uniquement pour le groupe %(group_name)s.",
    ...
    "This short name for the assignment type (for example, HW or Midterm) appears next to assignments on a learner's Progress page.": "Le nom court pour ce type de devoirs (par exemple, HW ou Midterm) apparait \u00e0 c\u00f4t\u00e9 des devoirs sur la page de progression de l'\u00e9tudiant.",
    "This team does not have any members.": "Cette \u00e9quipe n'a pas de membres.",
    "This team is full.": "Cette \u00e9quipe est pleine.",
    "This thread is closed.": "Ce fil de discussion est ferm\u00e9.",
    ...
    "Thumbnail": "Onglet",
    "Thumbnail for {videoName}": "Miniature de {videoName}",
    ...
    "To continue learning with this account, sign in below.": "Pour continuer \u00e0 utiliser ce compte, connectez-vous ici.",
    "To delete your account, please email {link}.": "Pour supprimer votre compte, envoyez un e-mail \u00e0 l'adresse {link}.",
    "To finalize course credit, %(display_name)s requires %(platform_name)s learners to submit a credit request.": "Pour finaliser l'obtention de cr\u00e9dit de cours, %(display_name)s demande aux \u00e9tudiants de %(platform_name)s de soumettre une demande de cr\u00e9dit.",
    "To invalidate a certificate for a particular learner, add the username or email address below.": "Pour invalider le certificat d'un \u00e9tudiant, ajoutez le nom d'utilisateur ou l'adresse e-mail ci-dessous.",
    ...
    "To receive credit for problems, you must select \"Submit\" for each problem before you select \"End My Exam\".": "Pour recevoir des cr\u00e9dits pour votre probl\u00e8me, cliquez sur \"Envoyer\" pour chaque probl\u00e8me avant de s\u00e9lectionner \"Terminer mon examen\".",
    ...
    "To share your certificate on Mozilla Backpack, you must first have a Backpack account. Complete the following steps to add your certificate to Backpack.": "Pour partager votre certificat sur Mozilla Backpack, vous devez d'abord avoir un compte Backpack. Compl\u00e9tez les \u00e9tapes suivantes pour ajouter votre certificat \u00e0 Backpack.",
    "To take a successful photo, make sure that:": "Pour prendre une bonne photo, assurez-vous que\u00a0: ",
    "To take the photo of your face, click on the camera button {icon}. If you need to try again, click 'Retake Photo'.": "Pour prendre une photo de votre visage, cliquez sur le bouton de la cam\u00e9ra {icon}. Si vous devez r\u00e9essayer, cliquez sur Reprendre une photo.",
    ...
    "Today": "Aujourd'hui",
    "Toggle Account Password (Usable/Unusable)": "Activer/D\u00e9sactiver le mot de passe",
    "Toggle Notifications Setting": "Changer les param\u00e8tres des notifications",
    "Tomorrow": "Demain",
    "Tools": "Outils",
    "Top": "Haut",
    "Topic": "Sujet\u00a0",
    "Topic area": "Sujet de discussion",
    "Topics": "Sujets\u00a0",
    "Total": "Total",
    ...
    "Type": "Type",
    "Type in a URL or use the \"Choose File\" button to upload a file from your machine. (e.g. 'http://example.com/img/clouds.jpg')": "Saisissez l'URL ou utilisez le bouton \"Choisir un fichier\" pour charger un fichier provenant de votre ordinateur. (Par ex.\u00a0: http://example.com/img/clouds.jpg)",
    "Type into this box to filter down the list of available %s.": "\u00c9crivez dans cette zone pour filtrer la liste des \u00ab\u00a0%s\u00a0\u00bb disponibles.",
    "URL": "URL\u00a0:",
    "Unable to delete account": "Impossible de supprimer le compte",
    "Unable to determine whether we should give you a refund because of System Error. Please try again later.": "Une erreur syst\u00e8me nous emp\u00eache de d\u00e9terminer si vous avez ou non droit \u00e0 un remboursement. Veuillez r\u00e9essayer plus tard.",
    "Unable to load": "Chargement impossible",
    "Unable to submit application": "Impossible d'envoyer votre demande",
    "Underline": "Souligner",
    "Undo": "Annule",
    ...
    "Upgrade Deadline": "Date limite pour la mise \u00e0 niveau",
    "Upgrade to Verified": "Opter pour un certificat",
    "Upgrade to a Verified Certificate for {courseName}": "Opter pour un certificat avec v\u00e9rification d'identit\u00e9 pour le cours {courseName}",
    "Upload": "T\u00e9l\u00e9charger",
    "Upload File": "T\u00e9l\u00e9charger un fichier",
    "Upload File and Assign Students": "Charger le fichier et associer les \u00e9tudiants",
    "Upload Memberships": "Charger les adh\u00e9sions",
    "Upload New .srt Transcript": "T\u00e9l\u00e9charger une nouvelle transcription .srt",
    "Upload New File": "T\u00e9l\u00e9charger un nouveau fichier",
    "Upload New Transcript": "T\u00e9l\u00e9charger une nouvelle transcription",
    ...
    "Upload a comma separated values (.csv) file that contains the usernames or email addresses of learners who have been given exceptions. Include the username or email address in the first comma separated field. You can include an optional note describing the reason for the exception in the second comma separated field.": "T\u00e9l\u00e9chargez un fichier de valeurs s\u00e9par\u00e9es par des virgules (.csv) qui continent les noms d'utilisateurs ou les adresses e-mail des \u00e9tudiants qui ont obtenu une d\u00e9rogation. Indiquez le nom d'utilisateur ou l'adresse e-mail dans le premier champ. Vous pouvez inclure une note d\u00e9crivant la raison de cette d\u00e9rogation dans le second champ.",
    "Upload a new PDF to \u201c<%= name %>\u201d": "T\u00e9l\u00e9chargez un nouveau PDF appel\u00e9 \"<%= name %>\".",
    ...
    "Upload instructor image.": "Charger l'image de l'enseignant",
    ...
    "Upload signature image.": "Charger l'image de signature.",
    "Upload translation": "T\u00e9l\u00e9charger une traduction",
    "Upload your banner image.": "T\u00e9l\u00e9chargez l'image de votre banni\u00e8re.",
    "Upload your course image.": "T\u00e9l\u00e9chargez votre image de cours.",
    "Upload your first asset": "T\u00e9l\u00e9charger votre premi\u00e8re ressource",
    "Upload your video thumbnail image.": "Chargez votre image de miniature vid\u00e9o.",
    "Uploaded file issues. Click on \"+\" to view.": "Liste des fichiers t\u00e9l\u00e9charg\u00e9s. Cliquez sur \"+\" pour la consulter.",
    "Uploading": "Chargement en cours",
    "Upper Alpha": "Capitales alphanum\u00e9riques",
    "Upper Roman": "Capitale Romain",
    "Upset Learner": "\u00c9tudiant non\u00a0satisfait",
    "Url": "Url",
    "Use Current Transcript": "Utiliser la transcription courante",
    "Use Onboarding to introduce learners to proctoring, verify their identity, and create an onboarding profile. Learners must complete the onboarding profile step prior to taking a proctored exam. Profile reviews take 2+ business days.": "Utilisez l'option Int\u00e9gration pour introduire les \u00e9tudiants aux examens surveill\u00e9s, v\u00e9rifier leur identit\u00e9 et cr\u00e9er un profil d'int\u00e9gration. Les \u00e9tudiants doivent cr\u00e9er leur profil d'int\u00e9gration complet avant de pouvoir passer un examen surveill\u00e9. L'examen des profils prend au moins 2\u00a0jours ouvrables.",
    "Use a practice proctored exam to introduce learners to the proctoring tools and processes. Results of a practice exam do not affect a learner's grade.": "Utilisez un examen blanc surveill\u00e9 afin de familiariser les \u00e9tudiants au processus et aux outils de surveillance. Les r\u00e9sultats d'un examen blanc ne comptent pas pour la note finale de l'\u00e9tudiant.",
    ...
    "Use as a Prerequisite": "Utilis\u00e9 comme pr\u00e9requis",
    "Use bookmarks to help you easily return to courseware pages. To bookmark a page, click \"Bookmark this page\" under the page title.": "Utilisez les signets pour vous aider \u00e0 revenir facilement aux pages de cours. Pour ajouter un signet, cliquez sur \"Marquer cette page\" sous le titre de la page.",
    ...
    "Use my university info": "Utiliser les informations de mon universit\u00e9",
    "Use the All Topics menu to find specific topics.": "Menu \"Tous les sujets\" pour trouver un sujet sp\u00e9cifique",
    ...
    "Verified Certificate upgrade": "Opter pour un certificat v\u00e9rifi\u00e9",
    ...
    "Video image upload started": "D\u00e9marrage du chargement de l'image",
    ...
    "View": "Afficher",
    "View Archived Course": "Afficher le cours archiv\u00e9",
    "View Cohort": "Afficher la cohorte",
    "View Course": "Afficher le cours",
    "View Current Team Memberships": "Afficher les adh\u00e9sions actuelles \u00e0 l'\u00e9quipe",
    "View Live": "Version live",
    "View Program Record": "Afficher le dossier de programme",
    "View Teams in the {topic_name} Topic": "Afficher les \u00e9quipes pour le sujet {topic_name}",
    "View all errors": "Afficher toutes les erreurs",
    "View child items": "Afficher les \u00e9l\u00e9ments enfants",
    "View discussion": "Afficher la discussion",
    "View my exam": "Voir mon examen",
    "View {span_start} {team_name} {span_end}": "Afficher {span_start} {team_name} {span_end}",
    "Viewing %s course": [
      "Voir %s cours",
      "Voir %s cours"
    ],
    ...
    "We couldn't find any results for \"%s\".": "Aucun r\u00e9sultat pour \"%s\".",
    ...
    "We securely encrypt your photo and send it to our authorization service for review. Your photo and information are not saved or visible anywhere on %(platformName)s after the verification process is complete.": "Nous chiffrons votre photo de fa\u00e7on s\u00e9curis\u00e9e et l'envoyons \u00e0 notre service d'autorisation pour examen. Votre photo et vos informations ne sont pas enregistr\u00e9es et ne sont visibles \u00e0 aucun endroit sur %(platformName)s \u00e0 l'issue du processus de v\u00e9rification.",
    ...
    "We're sorry, there was an error": "D\u00e9sol\u00e9, une erreur est survenue.",
    ...
    "We've sent a confirmation message to {new_email_address}. Click the link in the message to update your email address.": "Un message de confirmation a \u00e9t\u00e9 envoy\u00e9 \u00e0 {new_email_address}. Cliquez sur le lien dans le message afin de mettre \u00e0 jour votre adresse e-mail.",
    "We've sent a confirmation message to {new_secondary_email_address}. Click the link in the message to update your secondary email address.": "Un message de confirmation a \u00e9t\u00e9 envoy\u00e9 \u00e0 {new_secondary_email_address}. Cliquez sur le lien dans le message afin de mettre \u00e0 jour votre adresse e-mail secondaire.",
    "We've sent a message to {email}. Click the link in the message to reset your password. Didn't receive the message? Contact {anchorStart}technical support{anchorEnd}.": "Nous avons envoy\u00e9 un e-mail \u00e0 l'adresse {email} . Cliquez sur le lien dans le message pour r\u00e9initialiser votre mot de passe. Vous n'avez pas re\u00e7u de message\u00a0? Contactez le {anchorStart}support technique{anchorEnd}.",
    "Web:": "Web\u00a0:",
    "Webcam": "Webcam",
    ...
    "What You Need for Verification": "Ce qui est n\u00e9cessaire pour la v\u00e9rification",
    "What can we help you with, {username}?": "\u00c0 quoi pouvons-nous vous \u00eatre utile, {username}?",
    ...
    "What if I can't see the camera image, or if I can't see my photo do determine which side is visible?": "Que faire si je ne vois pas d'image sur la cam\u00e9ra, ou si je ne vois pas ma photo, pour d\u00e9terminer quel c\u00f4t\u00e9 est visible\u00a0?",
    "What if I have difficulty holding my ID in position relative to the camera?": "Que faire si je ne parviens pas \u00e0 maintenir ma pi\u00e8ce d'identit\u00e9 en position correcte face \u00e0 la cam\u00e9ra\u00a0?",
    "What if I have difficulty holding my head in position relative to the camera?": "Que faire si je ne parviens pas \u00e0 maintenir la t\u00eate en position correcte face \u00e0 la cam\u00e9ra\u00a0?",
    "What's Your Next Accomplishment?": "Quel est votre prochain objectif\u00a0?",
    ...
    "When your face is in position, use the Take Photo button {icon} below to take your photo.": "Lorsque votre visage est correctement positionn\u00e9, utilisez le bouton Prendre une photo {icon} afin de prendre votre photo.",
    ...
    "Words: {0}": "Mots\u00a0: {0}",
    "Would you like to sign in using your %(providerName)s credentials?": "Souhaitez-vous vous connecter avec vos informations d'identification %(providerName)s\u00a0?",
    ...
    "Yesterday": "Hier",
    "You already belong to another team in this team set.": "Vous faites d\u00e9j\u00e0 partie d'une autre \u00e9quipe dans cet ensemble d'\u00e9quipes.",
    ...
    "You are currently sharing a limited profile.": "Vous utilisez actuellement un profil restreint.",
    "You are enrolling in: {courseName}": "Vous vous inscrivez au cours\u00a0: {courseName}",
    ...
    "You are sending an email message with the subject {subject} to the following recipients.": "Vous allez envoyer un e-mail ayant pour sujet {subject} aux destinataires suivants.",
    "You are taking \"{exam_link}\" as {exam_type}. ": "Vous passez l'examen \"{exam_link}\" de type {exam_type}. ",
    "You are upgrading your enrollment for: {courseName}": "Mise \u00e0 niveau de votre inscription pour le cours\u00a0: {courseName}",
    ...
    "You can link your social media accounts to simplify signing in to {platform_name}.": "Vous pouvez lier vos comptes de r\u00e9seaux sociaux afin de simplifier la connexion \u00e0 {platform_name}.",
    ...
    "You can pay now even if you don't have the following items available, but you will need to have these by {date} to qualify to earn a Verified Certificate.": "Vous pouvez payer maintenant m\u00eame s'il vous manque les \u00e9l\u00e9ments suivants, mais vous en aurez besoin avant le {date} afin d'obtenir un certificat v\u00e9rifi\u00e9.",
    ...
    "You can view your information or unlink from {enterprise_name} anytime in your Account Settings.": "Vous pouvez voir vos informations ou vous d\u00e9connecter de {enterprise_name} \u00e0 tout moment dans les param\u00e8tres du compte.",
    "You cannot view the course as a student or beta tester before the course release date.": "Vous ne pouvez pas voir le cours en tant qu'\u00e9tudiant ou en tant que b\u00eata-testeur avant la date de diffusion du cours.",
    "You changed a video URL, but did not change the timed transcript file. Do you want to use the current timed transcript or upload a new .srt transcript file?": "Vous avez chang\u00e9 l'URL d'une vid\u00e9o, sans changer le fichier de transcription synchronis\u00e9e. Souhaitez-vous utiliser le fichier courant de transcription synchronis\u00e9e ou t\u00e9l\u00e9charger un nouveau fichier srt de transcription\u00a0?",
    "You commented...": "Vous avez comment\u00e9...",
    "You could not be subscribed to this post. Refresh the page and try again.": "L'abonnement \u00e0 ce message a \u00e9chou\u00e9. Veuillez actualiser la page et essayer \u00e0 nouveau.",
    "You could not be unsubscribed from this post. Refresh the page and try again.": "Le d\u00e9sabonnement de ce message a \u00e9chou\u00e9. Veuillez actualiser la page et essayer \u00e0 nouveau.",
    ...
    "You have not bookmarked any courseware pages yet": "Vous n'avez ajout\u00e9 aucun signet pour le moment.",
    "You have not created any certificates yet.": "Vous n'avez pas encore cr\u00e9\u00e9 de certificat.",
    ...
    "You have selected \u201cDelete my account.\u201d Deletion of your account and personal data is permanent and cannot be undone. {platformName} will not be able to recover your account or the data that is deleted.": "Vous avez s\u00e9lectionn\u00e9 l'option Supprimer mon compte. La suppression de votre compte et de vos donn\u00e9es personnelles est irr\u00e9versible. {platformName} ne pourra pas r\u00e9cup\u00e9rer votre compte ni les donn\u00e9es supprim\u00e9es.",
    "You have set your language to {beta_language}, which is currently not fully translated. You can help us translate this language fully by joining the Transifex community and adding translations from English for learners that speak {beta_language}.": "Vous avez s\u00e9lectionn\u00e9 la langue {beta_language} dont la version n'est pas enti\u00e8rement localis\u00e9e. Vous pouvez nous aider \u00e0 terminer la traduction en rejoignant la communaut\u00e9 Transifex et en ajoutant des traductions \u00e0 partir de l'anglais pour les \u00e9tudiants qui parlent {beta_language}.",
    ...
    "You may access your account with this address if single-sign on or access to your primary email is not available.": "Vous pouvez acc\u00e9der \u00e0 votre compte en utilisant cette adresse si l'authentification unique ou l'acc\u00e8s \u00e0 votre adresse e-mail principale n'est pas disponible.",
    ...
    "You may be able to complete the image capture procedure without assistance, but it may take a couple of submission attempts to get the camera positioning right.  Optimal camera positioning varies with each computer, but generally the best position for a headshot is approximately 12-18 inches (30-45 centimeters) from the camera, with your head centered relative to the computer screen. ": "Vous pourrez peut-\u00eatre terminer la proc\u00e9dure de capture d'image sans assistance, mais il est possible que vous deviez faire plusieurs essais pour arriver \u00e0 positionner la cam\u00e9ra correctement. Le positionnement optimal varie d'un ordinateur \u00e0 l'autre mais, en g\u00e9n\u00e9ral, la meilleure position pour une photo du visage est de 30 \u00e0 45\u00a0cm de la cam\u00e9ra, en veillant \u00e0 centrer le visage par rapport \u00e0 l'\u00e9cran.",
    "You may be able to complete the image capture procedure without assistance, but it may take a couple of submission attempts to get the camera positioning right.  Optimal camera positioning varies with each computer, but generally, the best position for a photo of an ID card is 8-12 inches (20-30 centimeters) from the camera, with the ID card centered relative to the camera. ": "Vous pourrez peut-\u00eatre terminer la proc\u00e9dure de capture d'image sans assistance, mais il est possible que vous deviez faire plusieurs essais pour arriver \u00e0 positionner la cam\u00e9ra correctement. Le positionnement optimal varie d'un ordinateur \u00e0 l'autre mais, en g\u00e9n\u00e9ral, la meilleure position pour une photo de la pi\u00e8ce d'identit\u00e9 est de 20 \u00e0 30\u00a0cm de la cam\u00e9ra, en veillant \u00e0 centrer la pi\u00e8ce d'identit\u00e9 par rapport \u00e0 la cam\u00e9ra.",
    ...
    "You must specify your birth year before you can share your full profile. To specify your birth year, go to the {account_settings_page_link}": "Vous devez renseigner votre ann\u00e9e de naissance avant de pouvoir partager votre profil complet. Pour renseigner votre ann\u00e9e de naissance, allez \u00e0 la {account_settings_page_link}",
    "You need a device that has a webcam. If you receive a browser prompt for access to your camera, please make sure to click 'Allow'.": "Vous devez utiliser un appareil muni d'une webcam. Si vous recevez un message de navigateur vous demandant d'acc\u00e9der \u00e0 votre cam\u00e9ra, cliquez sur Autoriser. ",
    "You need a valid ID that contains your full name and photo.": "Vous devez utiliser une pi\u00e8ce d'identit\u00e9 valable avec votre nom complet et une photo.",
    "You need an ID with your name and photo. A driver's license, passport, or ID are all acceptable.": "Vous avez besoin d'un permis de conduire, un passeport ou toute pi\u00e8ce d'identit\u00e9 avec votre nom et photo.",
    ...
    "You need to activate your account before you can enroll in courses. Check your inbox for an activation email. After you complete activation you can return and refresh this page.": "Vous devez activer votre compte avant de pouvoir vous inscrire aux cours. V\u00e9rifier votre bo\u00eete de r\u00e9ception pour un e-mail d'activation. Apr\u00e8s l'activation vous pouvez revenir et rafra\u00eechir cette page.",
    "You receive messages from {platform_name} and course teams at this address.": "Les messages d'{platform_name} et des \u00e9quipes p\u00e9dagogiques vous seront envoy\u00e9s \u00e0 cette adresse.",
    "You receive messages from {platform_name} and course teams at this address. If your employer has changed, please email {htmlStart}OnlineTraining@abinitio.com{htmlEnd} to update your email address. (Only employer email addresses are accepted; personal email addresses are not allowed.)": "Les messages d'{platfrom_name} et des \u00e9quipes p\u00e9dagogiques vous sont envoy\u00e9s \u00e0 cette adresse. Si vous changez d'employeur, envoyez un e-mail \u00e0 l'adresse {htmlStart}OnlineTraining@abinitio.com{htmlEnd} pour mettre \u00e0 jour votre adresse e-mail. (Seules les adresses e-mail professionnelles sont accept\u00e9es\u00a0; les adresses personnelles ne sont pas autoris\u00e9es.)",
    "You reserve all rights for your work": "Vous vous r\u00e9servez tous les droits pour votre travail",
    "You still need to visit the %(display_name)s website to complete the credit process.": "Vous devez encore visiter le site web de %(display_name)s afin de compl\u00e9ter le processus de cr\u00e9dit.",
    ...
    "You will not receive notification for emails that bounce, so double-check your spelling.": "Vous ne recevrez pas de notification pour les e-mails rejet\u00e9s. Faites attention \u00e0 l'orthographe.",
    ...
    "Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.": "Votre navigateur ne prend pas en charge l'acc\u00e8s direct au Presse-papiers. Utilisez les raccourcis clavier Ctrl + X / C / V \u00e0 la place.",
    ...
    "Your donation could not be submitted.": "Votre don n'a pas pu \u00eatre envoy\u00e9",
    "Your email message was successfully queued for sending. In courses with a large number of learners, email messages to learners might take up to an hour to be sent.": "Votre e-mail a \u00e9t\u00e9 mis sur liste d'attente avec succ\u00e8s pour l'envoi. Pour les cours avec un grand nombre d'\u00e9tudiants, l'envoi des e-mails peut prendre jusqu'\u00e0 une heure.",
    "Your entire face fits inside the frame.": "Votre visage est enti\u00e8rement dans le cadre.",
    "Your export has failed.": "Votre export a \u00e9chou\u00e9.",
    "Your face is well-lit.": "Votre visage est bien \u00e9clair\u00e9",
    "Your file ": "Votre fichier",
    "Your file '{file}' has been uploaded. Allow a few minutes for processing.": "Votre fichier \"{file}\" a \u00e9t\u00e9 import\u00e9. Veuillez patienter quelques minutes pour son traitement.",
    ...
    "Your file {filename} is too large (max size: {maxSize}MB).": "Votre fichier {filename} est trop grand (taille max\u00a0: {maxSize} Mo).",
    "Your import has failed.": "Votre import a \u00e9chou\u00e9.",
    ...
    "Your preferred language for course text, exercise instructions, and closed captions. In some courses, the videos are also localized. Not all courses are available in all languages. When a course is available in your preferred language, it is selected by default and is also displayed first in search results.": "Pr\u00e9f\u00e9rence de langue pour le texte des cours, les instructions des exercices et les sous-titres. Tous les cours ne sont pas disponibles dans toutes les langues. Lorsqu'un cours est disponible dans la langue que vous avez choisie, il est s\u00e9lectionn\u00e9 par d\u00e9faut et affich\u00e9 en premier dans les r\u00e9sultats de la recherche.",
    "Your profile settings are managed by {enterprise_name}. Contact your administrator or {link_start}edX Support{link_end} for help.": "Vos param\u00e8tres de profil sont g\u00e9r\u00e9s par {enterprise_name}. Contactez votre administrateur ou le {link_start}support\u00a0edX{link_end} en cas de besoin.",
    "Your question or idea (required)": "Votre question ou message (requis)",
    "Your request could not be completed due to a server problem. Reload the page and try again. If the issue persists, click the Help tab to report the problem.": "Votre demande n'a pas pu \u00eatre envoy\u00e9e \u00e0 cause d'un probl\u00e8me de serveur. Actualisez la page et r\u00e9essayez. Si le probl\u00e8me persiste, cliquez sur l'onglet Aide pour signaler le probl\u00e8me.",
    "Your request could not be completed. Reload the page and try again.": "Votre demande n'a pas pu \u00eatre envoy\u00e9e. Actualisez la page et r\u00e9essayez.",
    "Your request could not be completed. Reload the page and try again. If the issue persists, click the Help tab to report the problem.": "Votre requ\u00eate n'a pu \u00eatre finalis\u00e9e. Rechargez la page et essayez \u00e0 nouveau. Si le probl\u00e8me persiste, cliquez sur l'onglet Aide afin de signaler le probl\u00e8me.",
    ...
    "anonymous": "anonyme",
    "answer": "r\u00e9ponse",
    "answered question": "question avec r\u00e9ponse",
    ...
    "e.g. 'Sky with clouds'. The description is helpful for users who cannot see the image.": "Ex.\u00a0:\"Ciel nuageux\". La description est utile pour les utilisateurs qui ne peuvent pas voir l'image.",
    "e.g. 'google'": "Ex.\u00a0: \"google\"",
    "e.g. 'http://google.com'": "Ex.\u00a0: \"http://google.fr/\"",
    "e.g. johndoe@example.com, JaneDoe, joeydoe@example.com": "Ex.\u00a0: johndoe@exemple.com, JaneDoe, joeydoe@exemple.com",
    ...
    "enter code here": "saisissez votre code ici",
    ...
    "{ReqTextSpanStart}Requirements{spanEnd}{lineBreak}{InstructionsSpanStart}{videoImageResoultion}{lineBreak} {videoImageSupportedFileFormats}{spanEnd}": "{ReqTextSpanStart}Pr\u00e9-requis{spanEnd}{lineBreak}{InstructionsSpanStart}{videoImageResoultion}{lineBreak} {videoImageSupportedFileFormats}{spanEnd}",
    ...
    "{download_link_start}Download this image (right-click or option-click, save as){link_end} and then {upload_link_start}upload{link_end} it to your backpack.": "{download_link_start}T\u00e9l\u00e9chargez cette image (clic droit, ou cliquer et enregistrer sous){ink_end}, puis {upload_link_start}chargez{link_end}-la dans votre backpack.",
    ...
    "{filename} exceeds maximum size of {maxFileSizeInGB} GB.": "{filename} d\u00e9passe la taille maximale de {maxFileSizeInGB} Go.",
    "{filename} is not in a supported file format. Supported file formats are {supportedFileFormats}.": "Le format de fichier de {filename} n'est pas pris en charge. Les formats de fichier pris en charge sont les suivants\u00a0: {supportedFileFormats}",
    "{hours}:{minutes} (current UTC time)": "{hours}:{minutes} (heure actuelle UTC )",
    "{htmlStart}Want to change your email, name, or password instead?{htmlEnd}": "{htmlStart} Souhaitez-vous modifier votre e-mail, nom ou mot de passe\u00a0?{htmlEnd}",
    "{label}: {status}": "{label}\u00a0: {status}",
    "{maxWidth}x{maxHeight} pixels": "{maxWidth}x{maxHeight} pixels",
    "{minutes} {unit}": "{minutes} {unit}",
    "{numMoved} learner was moved from {prevCohort}": [
      "{numMoved} \u00e9tudiant a \u00e9t\u00e9 transf\u00e9r\u00e9 vers {prevCohort}.",
      "{numMoved} \u00e9tudiants ont \u00e9t\u00e9 transf\u00e9r\u00e9s vers {prevCohort}."
    ],
    "{numPreassigned} learner was pre-assigned for this cohort. This learner will automatically be added to the cohort when they enroll in the course.": [
      "{numPreassigned} \u00e9tudiant est pr\u00e9-assign\u00e9 \u00e0 cette cohorte. Il y sera automatiquement ajout\u00e9 lorsqu'il s'inscrira au cours.",
      "{numPreassigned} \u00e9tudiants sont pr\u00e9-assign\u00e9s \u00e0 cette cohorte. Ils y seront automatiquement ajout\u00e9s lorsqu'ils s'inscriront au cours."
    ],
    "{numPresent} learner was already in the cohort": [
      "{numPresent} \u00e9tudiant faisait d\u00e9j\u00e0 partie de cette cohorte.",
      "{numPresent} \u00e9tudiants faisaient d\u00e9j\u00e0 partie de cette cohorte."
    ],
    ...
    "{num_points} point possible (graded, results hidden)": [
      ...
      "{num_points} points possibles (not\u00e9, r\u00e9sultats masqu\u00e9s)"
    ],
    "{num_points} point possible (ungraded)": [
      "{num_points} point possible (non\u00a0not\u00e9)",
      "{num_points} points possibles (non\u00a0not\u00e9)"
    ],
    "{num_points} point possible (ungraded, results hidden)": [
      "{num_points} point possible (non\u00a0not\u00e9, r\u00e9sultats masqu\u00e9s)",
      "{num_points} points possibles (non\u00a0not\u00e9, r\u00e9sultats masqu\u00e9s)"
    ],
    "{organization}\\'s logo": "logo {organization}",
    "{paragraphStart}You entered {boldStart}{email}{boldEnd}. If this email address is associated with your {platform_name} account, we will send a message with password recovery instructions to this email address.{paragraphEnd}{paragraphStart}If you do not receive a password reset message after 1 minute, verify that you entered the correct email address, or check your spam folder.{paragraphEnd}{paragraphStart}If you need further assistance, {anchorStart}contact technical support{anchorEnd}.{paragraphEnd}": "{paragraphStart}Vous avez indiqu\u00e9 {boldStart}{email}{boldEnd}. Si cette adresse e-mail est associ\u00e9e \u00e0 votre compte sur {platform_name}, nous vous enverrons un e-mail avec des instructions de r\u00e9cup\u00e9ration du mot de passe \u00e0 cette adresse e-mail.{paragraphEnd}{paragraphStart}Si vous n'avez pas re\u00e7u d'e-mail de r\u00e9initialisation de mot de passe apr\u00e8s une minute, v\u00e9rifiez que vous avez entr\u00e9 la bonne adresse e-mail, ou v\u00e9rifiez votre dossier spam.{paragraphEnd}{paragraphStart}Si vous avez besoin d'aide, {anchorStart}contactez le support technique{anchorEnd}.{paragraphEnd}",
    ...
    "{start_strong}{total}{end_strong} words submitted in total.": "{start_strong}{total}{end_strong} mots envoy\u00e9s au total.",
    "{strongStart}Warning: Account deletion is permanent.{strongEnd} Please read the above carefully before proceeding. This is an irreversible action, and {strongStart}you will no longer be able to use the same email on {platformName}.{strongEnd}": "{strongStart}Avertissement\u00a0: La suppression du compte est permanente.{strongEnd} Lisez attentivement la mention ci-dessus avant de poursuivre. Cette action est irr\u00e9versible, et {strongStart}vous ne pourrez plus utiliser la m\u00eame adresse e-mail sur {platformName}.{strongEnd}",
    "{team_count} Team": [
      "{team_count} \u00e9quipe",
      "{team_count} \u00e9quipes"
    ],
    ...
    "{type} Progress": "Progression de {type} ",
