...
def store_row(data, abs_filepath):
    ...
    with open(abs_filepath, "a+") as csv_file:
        ...
        try:
            ...
            log.error(f"UnicodeEncodeError occurred trying to store the row {data}, error: {e}")
...
def cleanup_directory_user_files(dir_path, user_id, filename_user_id_getter):
    ...
    for the_file in os.listdir(dir_path):
        ...
        try:
            ...
            log.error(f"An error occurred while cleaning up dir {dir_path} for user_id {e}")
