...
#RACCOONGANG
VIDEO_SIGNING_SERVICE_URL = ENV_TOKENS.get('VIDEO_SIGNING_SERVICE_URL', VIDEO_SIGNING_SERVICE_URL)
SSO_PROVIDER_FOR_LOGIN_REDIRECT = ENV_TOKENS.get('SSO_PROVIDER_FOR_LOGIN_REDIRECT', SSO_PROVIDER_FOR_LOGIN_REDIRECT)
VIDEO_LIBRARY_COURSE = ENV_TOKENS.get('VIDEO_LIBRARY_COURSE', '')
AB_INITIO_LOGOUT_REDIRECT_URL = ENV_TOKENS.get('AB_INITIO_LOGOUT_REDIRECT_URL', '')
AB_INITIO_ACCOUNT_DELETION_EMAIL = ENV_TOKENS.get('AB_INITIO_ACCOUNT_DELETION_EMAIL', AB_INITIO_ACCOUNT_DELETION_EMAIL)
# password reset url defaults to stage environment
AB_INITIO_PASSWORD_RESET_URL = ENV_TOKENS.get('AB_INITIO_PASSWORD_RESET_URL', AB_INITIO_PASSWORD_RESET_URL)
