...
def get_course_tab_list(request, course):
    ...
    for tab in xmodule_tab_list:
        ...
        if tab.type == "course_info" or tab.type == 'static_tab' and tab.course_staff_only and tab.course_staff_only and \
                not bool(user and has_access(user, 'staff', course, course.id)) \
                or tab.type == 'video' and tab.course_staff_only and tab.course_staff_only and \
                not bool(user and has_access(user, 'staff', course, course.id)):
            continue
