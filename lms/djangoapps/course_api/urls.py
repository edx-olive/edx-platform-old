...
from .views import CourseDetailView, CourseListView, AppliedXCourseListView


urlpatterns = patterns(
    '',
    url(r'^v1/courses/$', CourseListView.as_view(), name="course-list"),
    url(r'^v1/appliedx_courses/$', AppliedXCourseListView.as_view(), name="appliedx-course-list"),
