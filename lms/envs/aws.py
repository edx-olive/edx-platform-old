...
# AMAT cloudfront configs
AWS_ACCESS_KEY_ID = ENV_TOKENS.get("AWS_ACCESS_KEY_ID")
AWS_SECRET_ACCESS_KEY = ENV_TOKENS.get("AWS_SECRET_ACCESS_KEY")
SIGNING_KEY_ID = ENV_TOKENS.get("SIGNING_KEY_ID")
SIGNING_KEY_FILE = ENV_TOKENS.get("SIGNING_KEY_FILE")
...
if FEATURES.get('ENABLE_OAUTH2_PROVIDER'):
    ...
    # Required for AMAT iOS app; note: on iOS app, `APP_SCHEMA_URL` equals to "appliedxproduction://?"
    APP_SCHEMA_URL = ENV_TOKENS.get('APP_SCHEMA_URL', 'appliedxproduction')
