...
def add_enrollment(username, course_id, mode=None, is_active=True, enrollment_attributes=None, check_access=True):
    ...
    Arguments:
        ...
        check_access (boolean): Determines if we need to check if user is allowed to enroll (defaults to True).
    ...
    enrollment = _data_api().create_course_enrollment(username, course_id, mode, is_active, check_access)
